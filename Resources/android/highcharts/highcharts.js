(function() {
    ...
    function z(a, b, c) {
        var d, e;
        if (ga(b)) r(c) ? a.setAttribute(b, c) : a && a.getAttribute && (e = a.getAttribute(b)); else if (r(b) && $(b)) for (d in b) a.setAttribute(d, b[d]);
        return e;
    }
    function na(a) {
        return La(a) ? a : [ a ];
    ...
    function D(a, b) {
        Aa && !X && b && b.opacity !== u && (b.filter = "alpha(opacity=" + 100 * b.opacity + ")");
        s(a.style, b);
    }
    ...
    function Ga(a, b, c, d) {
        var e = L.lang, a = +a || 0, f = -1 === b ? (a.toString().split(".")[1] || "").length : isNaN(b = N(b)) ? 2 : b, b = void 0 === c ? e.decimalPoint : c, d = void 0 === d ? e.thousandsSep : d, e = 0 > a ? "-" : "", c = String(x(a = N(a).toFixed(f))), g = c.length > 3 ? c.length % 3 : 0;
    ...
    function Ia(a, b) {
        for (var e, f, g, h, i, c = "{", d = !1, j = []; -1 !== (c = a.indexOf(c)); ) {
            ...
            if (d) {
                ...
                f.length && (f = f.join(":"), g = /\.([0-9])/, h = L.lang, i = void 0, /f$/.test(f) ? (i = (i = f.match(g)) ? i[1] : -1, 
                e = Ga(e, i, h.decimalPoint, f.indexOf(",") > -1 ? h.thousandsSep : "")) : e = bb(f, e));
            }
            j.push(e);
            a = a.slice(c + 1);
            c = (d = !d) ? "}" : "{";
    ...
    function nb(a, b, c, d) {
        var e, c = o(c, 1);
        e = a / c;
        b || (b = [ 1, 2, 2.5, 5, 10 ], d && d.allowDecimals === !1 && (1 === c ? b = [ 1, 2, 5, 10 ] : .1 >= c && (b = [ 1 / c ])));
        for (d = 0; b.length > d; d++) if (a = b[d], (b[d] + (b[d + 1] || b[d])) / 2 >= e) break;
        a *= c;
        return a;
    }
    function Bb() {
    ...
    function Na(a) {
        for (var b = a.length, c = a[0]; b--; ) c > a[b] && (c = a[b]);
        return c;
    }
    function Ba(a) {
    ...
    function Cb() {
        ...
        Ra = 6e4 * (a && L.global.timezoneOffset || 0);
    ...
    var u, Za, $a, cb, L, bb, sa, ub, B, db, Ra, pb, qb, rb, Xa, eb, fb, Db, Eb, sb, Fb, Gb, y = document, G = window, T = Math, v = T.round, S = T.floor, Ka = T.ceil, t = T.max, E = T.min, N = T.abs, W = T.cos, ba = T.sin, la = T.PI, Ca = 2 * la / 360, ua = navigator.userAgent, Ib = G.opera, Aa = /msie/i.test(ua) && !Ib, gb = 8 === y.documentMode, hb = /AppleWebKit/.test(ua), Ta = /Firefox/.test(ua), Jb = /(Mobile|Android|Windows Phone)/.test(ua), Da = "http://www.w3.org/2000/svg", X = !!y.createElementNS && !!y.createElementNS(Da, "svg").createSVGRect, Ob = Ta && 4 > parseInt(ua.split("Firefox/")[1], 10), ca = !X && !Aa && !!y.createElement("canvas").getContext, Kb = {}, tb = 0, Ea = function() {}, Y = [], Ja = "div", O = "none", Pb = /^[0-9]+$/, Lb = "stroke-width", J = {}, Q = G.Highcharts = G.Highcharts ? oa(16, !0) : {};
    bb = function(a, b, c) {
        if (!r(b) || isNaN(b)) return "Invalid date";
        var e, a = o(a, "%Y-%m-%d %H:%M:%S"), d = new Date(b - Ra), f = d[qb](), g = d[rb](), h = d[Xa](), i = d[eb](), j = d[fb](), k = L.lang, l = k.weekdays, d = s({
            a: l[g].substr(0, 3),
            A: l[g],
            d: Ha(h),
            e: h,
    ...
    ub = {
        init: function(a, b, c) {
            ...
            if (c.length / f >= d && b.length === c.length) for (;d--; ) c = [].concat(c).splice(0, f).concat(c);
            a.shift = 0;
            if (b.length) for (a = c.length; a > b.length; ) d = [].concat(b).splice(b.length - f, f), 
            ...
            init: function(b) {
                ...
                a.each([ "cur", "_default", "width", "height", "opacity" ], function(a, b) {
                    ...
                    (k = e[b]) && (e[b] = function(c) {
                        var d, c = a ? c : this;
                        if ("align" !== c.prop) return d = c.elem, d.attr ? d.attr(c.prop, "cur" === b ? u : c.now) : k.apply(this, arguments);
                    });
                });
                ...
                a.fn.highcharts = function() {
                    ...
                    c = b[0];
                    c !== u && (c.chart = c.chart || {}, c.chart.renderTo = this[0], new Q[a](c, b[1]), 
                    d = this);
        ...
        return {
            ...
            brighten: function(a) {
                if (d) p(d, function(b) {
                    ...
                    var c;
                    for (c = 0; 3 > c; c++) b[c] += x(255 * a), 0 > b[c] && (b[c] = 0), b[c] > 255 && (b[c] = 255);
                }
                return this;
            },
            rgba: b,
    ...
    ta.prototype = {
        init: function(a, b) {
            this.element = "span" === b ? V(b) : y.createElementNS(Da, b);
            this.renderer = a;
            this.attrSetters = {};
        },
        opacity: 1,
        ...
        attr: function(a, b) {
            var c, d, e, f, j, m, n, g = this.element, h = g.nodeName.toLowerCase(), i = this.renderer, k = this.attrSetters, l = this.shadows, q = this;
            ga(a) && r(b) && (c = a, a = {}, a[c] = b);
            if (ga(a)) c = a, "circle" === h ? c = {
                x: "cx",
                y: "cy"
            }[c] || c : "strokeWidth" === c && (c = "stroke-width"), q = z(g, c) || this[c] || 0, 
            "d" !== c && "visibility" !== c && "fill" !== c && (q = parseFloat(q)); else {
                for (c in a) if (j = !1, d = a[c], e = k[c] && k[c].call(this, d, c), e !== !1) {
                    e !== u && (d = e);
                    if ("d" === c) d && d.join && (d = d.join(" ")), /(NaN| {2}|^$)/.test(d) && (d = "M 0 0"); else if ("x" === c && "text" === h) for (e = 0; g.childNodes.length > e; e++) f = g.childNodes[e], 
                    z(f, "x") === z(g, "x") && z(f, "x", d); else if (!this.rotation || "x" !== c && "y" !== c) if ("fill" === c) d = i.color(d, g, c); else if ("circle" !== h || "x" !== c && "y" !== c) if ("rect" === h && "r" === c) z(g, {
                        rx: d,
                        ry: d
                    }), j = !0; else if ("translateX" === c || "translateY" === c || "rotation" === c || "verticalAlign" === c || "scaleX" === c || "scaleY" === c) j = n = !0; else if ("stroke" === c) d = i.color(d, g, c); else if ("dashstyle" === c) {
                        if (c = "stroke-dasharray", d = d && d.toLowerCase(), "solid" === d) d = O; else if (d) {
                    ...
                    } else "width" === c ? d = x(d) : "align" === c ? (c = "text-anchor", d = {
                        left: "start",
                        center: "middle",
                        right: "end"
                    }[d]) : "title" === c && (e = g.getElementsByTagName("title")[0], e || (e = y.createElementNS(Da, "title"), 
                    g.appendChild(e)), e.textContent = d); else c = {
                        x: "cx",
                        y: "cy"
                    }[c] || c; else n = !0;
                    "strokeWidth" === c && (c = "stroke-width");
                    if ("stroke-width" === c || "stroke" === c) {
                        this[c] = d;
                        this.stroke && this["stroke-width"] ? (z(g, "stroke", this.stroke), z(g, "stroke-width", this["stroke-width"]), 
                    ...
                    m = !0), j = !0);
                    if (l && /^(width|height|visibility|x|y|d|transform|cx|cy|r)$/.test(c)) for (e = l.length; e--; ) z(l[e], c, "height" === c ? t(d - (l[e].cutHeight || 0), 0) : d);
                    ("width" === c || "height" === c) && "rect" === h && 0 > d && (d = 0);
                    this[c] = d;
                    "text" === c ? d !== this.textStr && (delete this.bBox, this.textStr = d, this.added && i.buildText(this)) : j || void 0 !== d && g.setAttribute(c, d);
                }
        ...
        css: function(a) {
            ...
            if (e) {
                e = this.textWidth = a && a.width && "text" === d.nodeName.toLowerCase() && x(a.width);
                b && (a = s(b, c));
                this.styles = a;
        ...
        on: function(a, b) {
            ...
            $a && "click" === a ? (d.ontouchstart = function(a) {
                c.touchEventFired = Date.now();
                a.preventDefault();
                b.call(d, a);
            }, d.onclick = function(a) {
                (-1 === ua.indexOf("Android") || Date.now() - (c.touchEventFired || 0) > 1100) && b.call(d, a);
            }) : d["on" + a] = b;
            return this;
        },
        ...
        align: function(a, b, c) {
            ...
            e = this.renderer;
            f = e.alignedObjects;
            a ? (this.alignOptions = a, this.alignByTranslate = b, !c || ga(c)) && (this.alignTo = d = c || "renderer", 
        ...
        getBBox: function() {
            ...
            d = this.textStr;
            var h;
            ("" === d || Pb.test(d)) && (h = d.toString().length + (f ? "|" + f.fontSize + "|" + f.fontFamily : ""), 
            a = b.cache[h]);
            if (!a) {
                ...
                if (b.isSVG) {
                    c = a.width;
                    d = a.height;
                    Aa && f && "11px" === f.fontSize && "16.9" === d.toPrecision(3) && (a.height = d = 14);
                    e && (a.width = N(d * ba(g)) + N(c * W(g)), a.height = N(d * W(g)) + N(c * ba(g)));
                }
                this.bBox = a;
                h && (b.cache[h] = a);
            }
        ...
        add: function(a) {
            ...
            if (c.handleZ) {
                a = d.childNodes;
                for (g = 0; a.length > g; g++) if (b = a[g], c = z(b, "zIndex"), b !== e && (x(c) > f || !r(f) && r(c))) {
                    d.insertBefore(e, b);
                    h = !0;
                    break;
                }
        ...
        destroy: function() {
            ...
            if (a.stops) {
                for (f = 0; a.stops.length > f; f++) a.stops[f] = a.stops[f].destroy();
                a.stops = null;
            }
            a.safeRemoveChild(b);
        ...
        shadow: function(a, b, c) {
            ...
            if (a) {
                ...
                for (e = 1; i >= e; e++) {
                    ...
                    c && (z(f, "height", t(z(f, "height") - h, 0)), f.cutHeight = h);
    ...
    pa.prototype = {
        ...
        init: function(a, b, c, d, e) {
            ...
            g = d.element;
            a.appendChild(g);
            -1 === a.innerHTML.indexOf("xmlns") && z(g, "xmlns", Da);
            this.isSVG = !0;
            this.box = g;
            this.boxWrapper = d;
            this.alignedObjects = [];
        ...
        buildText: function(a) {
            ...
            p(e, function(e, f) {
                ...
                p(l, function(e) {
                    if ("" !== e || 1 === l.length) {
                        var p, q = {}, o = y.createElementNS(Da, "tspan");
                        g.test(e) && (p = e.match(g)[1].replace(/(;| |^)color([ :])/, "$1fill$2"), z(o, "style", p));
                        h.test(e) && !d && (z(o, "onclick", 'location.href="' + e.match(h)[1] + '"'), D(o, {
                            cursor: "pointer"
                        }));
                        e = (e.replace(/<(.|\n)*?>/g, "") || " ").replace(/&lt;/g, "<").replace(/&gt;/g, ">");
                        if (" " !== e && (o.appendChild(y.createTextNode(e)), m ? q.dx = 0 : q.x = i, z(o, q), 
                        !m && f && (!X && d && D(o, {
                            display: "block"
                        }), z(o, "dy", n(o), hb && o.offsetHeight)), b.appendChild(o), m++, k)) for (var r, t, e = e.replace(/([^\^])-/g, "$1- ").split(" "), q = e.length > 1 && "nowrap" !== j.whiteSpace, s = a._clipHeight, A = [], v = n(), u = 1; q && (e.length || A.length); ) delete a.bBox, 
                        r = a.getBBox(), t = r.width, !X && c.forExport && (t = c.measureSpanWidth(o.firstChild.data, a.styles)), 
                        r = t > k, r && 1 !== e.length ? (o.removeChild(o.firstChild), A.unshift(e.pop())) : (e = A, 
                        A = [], e.length && (u++, s && u * v > s ? (e = [ "..." ], a.attr("title", a.textStr)) : (o = y.createElementNS(Da, "tspan"), 
                        z(o, {
                            dy: v,
                            x: i
                        }), p && z(o, "style", p), b.appendChild(o), t > k && (k = t)))), e.length && o.appendChild(y.createTextNode(e.join(" ").replace(/- /g, "-")));
                    }
                });
            });
        },
        button: function(a, b, c, d, e, f, g, h, i) {
            var l, m, n, q, o, p, j = this.label(a, b, c, i, null, null, null, null, "button"), k = 0, a = {
                x1: 0,
                y1: 0,
                x2: 0,
                y2: 1
            ...
            C(j.element, Aa ? "mouseout" : "mouseleave", function() {
                3 !== k && (l = [ e, f, g ][k], m = [ n, q, o ][k], j.attr(l).css(m));
            });
            j.setState = function(a) {
                (j.state = k = a) ? 2 === a ? j.attr(g).css(o) : 3 === a && j.attr(h).css(p) : j.attr(e).css(n);
            };
        ...
        arc: function(a, b, c, d, e, f) {
            $(a) && (b = a.y, c = a.r, d = a.innerR, e = a.start, f = a.end, a = a.x);
        ...
        symbols: {
            ...
            arc: function(a, b, c, d, e) {
                var f = e.start, c = e.r || c || d, g = e.end - .001, d = e.innerR, h = e.open, i = W(f), j = ba(f), k = W(g), g = ba(g), e = la > e.end - f ? 0 : 1;
        ...
        color: function(a, b, c) {
            var e, g, h, i, j, k, l, m, d = this, f = /^rgba/, n = [];
            ...
            if (g) {
                ...
                "radialGradient" === g && b && !r(c.gradientUnits) && (c = w(c, {
                    cx: b[0] - b[2] / 2 + c.cx * b[2],
                    cy: b[1] - b[2] / 2 + c.cy * b[2],
                    r: c.r * b[2],
                    gradientUnits: "userSpaceOnUse"
                }));
                for (m in c) "id" !== m && n.push(m, c[m]);
                for (m in j) n.push(j[m]);
                n = n.join(",");
                h[n] ? a = h[n].id : (c.id = a = "highcharts-" + tb++, h[n] = i = d.createElement(g).attr(c).add(d.defs), 
            ...
            return f.test(a) ? (e = wa(a), z(b, c + "-opacity", e.get("a")), e.get("rgb")) : (b.removeAttribute(c + "-opacity"), 
            a);
        },
        ...
        fontMetrics: function(a) {
            var a = a || this.style.fontSize, a = /px/.test(a) ? x(a) : /em/.test(a) ? 12 * parseFloat(a) : 12, a = 24 > a ? a + 4 : v(1.2 * a), b = v(.8 * a);
            return {
                h: a,
                b: b
            };
        ...
        label: function(a, b, c, d, e, f, g, h, i) {
            function j() {
                var a, b;
                a = q.element.style;
                K = (void 0 === Va || void 0 === wb || n.styles.textAlign) && q.textStr && q.getBBox();
                n.width = (Va || K.width || 0) + 2 * P + kb;
                n.height = (wb || K.height || 0) + 2 * P;
                xa = P + m.fontMetrics(a && a.fontSize).b;
                if (y) {
                    o || (a = v(-t * P), b = h ? -xa : 0, n.box = o = d ? m.symbol(d, a, b, n.width, n.height, A) : m.rect(a, b, n.width, n.height, 0, A[Lb]), 
                    o.attr("fill", O).add(n));
                    o.isImg || o.attr(w({
                        width: n.width,
                        height: n.height
            ...
            function k() {
                var c, a = n.styles, a = a && a.textAlign, b = kb + P * (1 - t);
                c = h ? 0 : xa;
                r(Va) && K && ("center" === a || "right" === a) && (b += {
                    center: .5,
                    right: 1
                }[a] * (Va - K.width));
                (b !== q.x || c !== q.y) && q.attr({
            ...
            var o, K, Va, wb, xb, yb, xa, y, m = this, n = m.g(i), q = m.text("", 0, 0, g).attr({
                zIndex: 1
            }), t = 0, P = 3, kb = 0, H = 0, A = {}, g = n.attrSetters;
            n.onAdd = function() {
                q.add(n);
                n.attr({
                    text: a,
    ...
    s(ta.prototype, {
        ...
        htmlUpdateTransform: function() {
            if (this.added) {
                ...
                if ("SPAN" === b.tagName) {
                    var k, j = this.rotation, l = x(this.textWidth), m = [ j, g, b.innerHTML, this.textWidth ].join(",");
                    if (m !== this.cTT) {
                        k = a.fontMetrics(b.style.fontSize).b;
                        r(j) && this.setSpanRotation(j, h, k);
                        i = o(this.elemWidth, b.offsetWidth);
                        i > l && /[ \-]/.test(b.textContent || b.innerText) && (D(b, {
                            width: l + "px",
                            display: "block",
                            whiteSpace: "normal"
                        }), i = l);
        ...
        setSpanRotation: function(a, b, c) {
            ...
            d[e + (Ta ? "Origin" : "-origin")] = d.transformOrigin = 100 * b + "% " + c + "px";
            D(this.element, d);
        },
    ...
    if (!X && !ca) {
        Q.VMLElement = da = {
            init: function(a, b) {
                ...
                c.push(' style="', d.join(""), '"/>');
                b && (c = e || "span" === b || "img" === b ? c.join("") : a.prepVML(c), this.element = V(c));
                this.renderer = a;
                this.attrSetters = {};
            },
            add: function(a) {
            ...
            getSpanCorrection: function(a, b, c, d, e) {
                var i, f = d ? W(d * Ca) : 1, g = d ? ba(d * Ca) : 0, h = o(this.elemHeight, this.element.offsetHeight);
                this.xCorr = 0 > f && -a;
                this.yCorr = 0 > g && -h;
                i = 0 > f * g;
            ...
            pathToVML: function(a) {
                for (var b = a.length, c = []; b--; ) ya(a[b]) ? c[b] = v(10 * a[b]) - 5 : "Z" === a[b] ? c[b] = "x" : (c[b] = a[b], 
                !a.isArc || "wa" !== a[b] && "at" !== a[b]) || (c[b + 5] === c[b + 7] && (c[b + 7] += a[b + 7] > a[b + 5] ? 1 : -1), 
                c[b + 6] === c[b + 8] && (c[b + 8] += a[b + 8] > a[b + 6] ? 1 : -1));
                return c.join(" ") || "x";
            },
            attr: function(a, b) {
                var c, d, e, k, m, f = this.element || {}, g = f.style, h = f.nodeName, i = this.renderer, j = this.symbolName, l = this.shadows, n = this.attrSetters, q = this;
                ga(a) && r(b) && (c = a, a = {}, a[c] = b);
                if (ga(a)) c = a, q = "strokeWidth" === c || "stroke-width" === c ? this.strokeweight : this[c]; else for (c in a) if (d = a[c], 
                m = !1, e = n[c] && n[c].call(this, d, c), e !== !1 && null !== d) {
                    e !== u && (d = e);
                    ...
                    k = !0), m = !0; else if ("d" === c) {
                        ...
                        "DIV" === h && (d = "hidden" === d ? "-999em" : 0, gb || (g[c] = d ? "visible" : "hidden"), 
                        c = "top");
                        g[c] = d;
                        m = !0;
                    } else "zIndex" === c ? (d && (g[c] = d), m = !0) : -1 !== va(c, [ "x", "y", "width", "height" ]) ? (this[c] = d, 
                    "x" === c || "y" === c ? c = {
                        x: "left",
                        y: "top"
                    }[c] : d = t(0, d), this.updateClipping ? (this[c] = d, this.updateClipping()) : g[c] = d, 
                    m = !0) : "class" === c && "DIV" === h ? f.className = d : "stroke" === c ? (d = i.color(d, f, c), 
                    c = "strokecolor") : "stroke-width" === c || "strokeWidth" === c ? (f.stroked = d ? !0 : !1, 
                    c = "strokeweight", this[c] = d, ya(d) && (d += "px")) : "dashstyle" === c ? ((f.getElementsByTagName("stroke")[0] || V(i.prepVML([ "<stroke/>" ]), null, null, f))[c] = d || "solid", 
                    this.dashstyle = d, m = !0) : "fill" === c ? "SPAN" === h ? g.color = d : "IMG" !== h && (f.filled = d !== O ? !0 : !1, 
                    d = i.color(d, f, c, this), c = "fillcolor") : "opacity" === c ? m = !0 : "shape" === h && "rotation" === c ? (this[c] = f.style[c] = d, 
                    f.style.left = -v(ba(d * Ca) + 1) + "px", f.style.top = v(W(d * Ca)) + "px") : ("translateX" === c || "translateY" === c || "rotation" === c) && (this[c] = d, 
                    this.updateTransform(), m = !0);
                    m || (gb ? f[c] = d : z(f, c, d));
                }
                return q;
            },
            ...
            cutOffPath: function(a, b) {
                var c, a = a.split(/[ ,]/);
                c = a.length;
                (9 === c || 11 === c) && (a[c - 4] = a[c - 2] = x(a[c - 2]) - 10 * b);
                return a.join(" ");
            },
            shadow: function(a, b, c) {
                var e, h, j, l, m, n, q, d = [], f = this.element, g = this.renderer, i = f.style, k = f.path;
        ...
        var ea = {
            ...
            color: function(a, b, c, d) {
                var f, h, i, e = this, g = /^rgba/, j = O;
                a && a.linearGradient ? i = "gradient" : a && a.radialGradient && (i = "pattern");
                if (i) {
                    var k, l, n, q, o, K, r, t, m = a.linearGradient || a.radialGradient, P = "", a = a.stops, s = [], v = function() {
                    ...
                    if ("fill" === c) if ("gradient" === i) c = m.x1 || m[0] || 0, a = m.y1 || m[1] || 0, 
                    n = m.x2 || m[2] || 0, m = m.y2 || m[3] || 0, P = 'angle="' + (90 - 180 * T.atan((m - a) / (n - c)) / la) + '"', 
                    v(); else {
                        var x, j = m.r, u = 2 * j, y = 2 * j, w = m.cx, A = m.cy, xa = b.radialReference, j = function() {
                            xa && (x = d.getBBox(), w += (xa[0] - x.x) / x.width - .5, A += (xa[1] - x.y) / x.height - .5, 
                            u *= xa[2] / x.width, y *= xa[2] / x.height);
                ...
                } else if (g.test(a) && "IMG" !== b.tagName) f = wa(a), h = [ "<", c, ' opacity="', f.get("a"), '"/>' ], 
                V(this.prepVML(h), null, null, b), j = f.get("rgb"); else {
            ...
            createElement: function(a) {
                return "rect" === a ? this.symbol(a) : pa.prototype.createElement.call(this, a);
            },
            ...
            symbols: {
                ...
                rect: function(a, b, c, d, e) {
                    var h, f = a + c, g = b + d;
                    r(e) && e.r ? (h = E(e.r, c, d), f = [ "M", a + h, b, "L", f - h, b, "wa", f - 2 * h, b, f, b + 2 * h, f - h, b, f, b + h, "L", f, g - h, "wa", f - 2 * h, g - 2 * h, f, g, f, g - h, f - h, g, "L", a + h, g, "wa", a, g - 2 * h, a + 2 * h, g, a + h, g, a, g - h, "L", a, b + h, "wa", a, b, a + 2 * h, b + 2 * h, a, b + h, a + h, b, "x", "e" ]) : f = pa.prototype.symbols.square.apply(0, arguments);
                    return f;
                }
            }
        };
    ...
    var Mb;
    ca && (Q.CanVGRenderer = da = function() {
    ...
    Sa.prototype = {
        addLabel: function() {
            var l, a = this.axis, b = a.options, c = a.chart, d = a.horiz, e = a.categories, f = a.names, g = this.pos, h = b.labels, i = a.tickPositions, d = d && e && !h.step && !h.staggerLines && !h.rotation && c.plotWidth / i.length || !d && (c.margin[3] || .33 * c.chartWidth), j = g === i[0], k = g === i[i.length - 1], f = e ? o(e[g], f[g], g) : g, e = this.label, m = i.info;
            ...
            if (r(e)) e && e.attr({
                ...
                ya(h.rotation) && (l.rotation = h.rotation);
                d && h.ellipsis && (l._clipHeight = a.len / i.length);
        ...
        handleOverflow: function(a, b) {
            var l, m, n, c = !0, d = this.axis, e = this.isFirst, f = this.isLast, g = d.horiz ? b.x : b.y, h = d.reversed, i = d.tickPositions, j = this.getLabelSides(), k = j[0], j = j[1], q = this.label.line || 0;
            l = d.labelEdge;
            ...
            if (m) {
                ...
                e && !h || f && h ? l > g + k && (g = l - k, n && g + j > d && (c = !1)) : g + j > m && (g = m - j, 
                n && d > g + k && (c = !1));
                b.x = g;
            }
            return c;
        ...
        render: function(a, b, c) {
            ...
            m && t && ("inside" === s && (t = -t), d.opposite && (t = -t), h = this.getMarkPath(H, w, t, m * A, g, f), 
            n ? n.animate({
                d: h,
                opacity: c
            ...
            i && !isNaN(H) && (i.xy = w = this.getLabelPosition(H, w, i, g, k, y, a, v), this.isFirst && !this.isLast && !o(e.showFirstLabel, 1) || this.isLast && !this.isFirst && !o(e.showLastLabel, 1) ? x = !1 : !d.isRadial && !k.step && !k.rotation && !b && 0 !== c && (x = this.handleOverflow(a, w)), 
            v && a % v && (x = !1), x && !isNaN(w.y) ? (w.opacity = c, i[this.isNew ? "attr" : "animate"](w), 
    ...
    Q.PlotLineOrBand.prototype = {
        render: function() {
            var p, a = this, b = a.axis, c = b.horiz, d = (b.pointRange || 0) / 2, e = a.options, f = e.label, g = a.label, h = e.width, i = e.to, j = e.from, k = r(j) && r(i), l = e.value, m = e.dashStyle, n = a.svgElem, q = [], K = e.color, s = e.zIndex, P = e.events, v = b.chart.renderer;
            b.isLog && (j = za(j), i = za(i), l = za(l));
            if (h) (q = b.getPlotLinePath(l, h), d = {
                stroke: K,
                "stroke-width": h
            }, m) && (d.dashstyle = m); else {
                if (!k) return;
                (j = t(j, b.min - d), i = E(i, b.max + d), q = b.getPlotBandPath(j, i, e), d = {
                    fill: K
            ...
            if (n) q ? n.animate({
                ...
                n.show();
            }, g) && (a.label = g = g.destroy()); else if (q && q.length && (a.svgElem = n = v.path(q).attr(d).add(), 
            P)) for (p in e = function(b) {
                n.on(b, function(c) {
                    P[b].apply(a, [ c ]);
                });
            }, P) e(p);
            if (f && r(f.text) && q && q.length && b.width > 0 && b.height > 0) {
                ...
                g || (a.label = g = v.text(f.text, 0, 0, f.useHTML).attr({
    ...
    ka.prototype = {
        ...
        init: function(a, b) {
            ...
            -1 === va(this, a.axes) && (c && !this.isColorAxis ? a.axes.splice(a.xAxis.length, 0, this) : a.axes.push(this), 
            a[this.coll].push(this));
            this.series = this.series || [];
            a.inverted && c && this.reversed === u && (this.reversed = !0);
            this.removePlotLine = this.removePlotBand = this.removePlotBandOrLine;
            for (f in d) C(this, f, d[f]);
            this.isLog && (this.val2lin = za, this.lin2val = ha);
        },
        ...
        defaultLabelFormatter: function() {
            var g, a = this.axis, b = this.value, c = a.categories, d = this.dateTimeLabelFormat, e = L.lang.numericSymbols, f = e && e.length, h = a.options.labels.format, a = a.isLog ? b : a.tickInterval;
            if (h) g = Ia(h, this); else if (c) g = b; else if (d) g = bb(d, b); else if (f && a >= 1e3) for (;f-- && g === u; ) c = Math.pow(1e3, f + 1), 
        ...
        getSeriesExtremes: function() {
            ...
            p(a.series, function(c) {
                if (c.visible || !b.options.chart.ignoreHiddenSeries) {
                    ...
                    a.isLog && 0 >= d && (d = null);
                    if (a.isXAxis) (d = c.xData, d.length) && (a.dataMin = E(o(a.dataMin, d[0]), Na(d)), 
                    a.dataMax = t(o(a.dataMax, d[0]), Ba(d))); else {
                        c.getExtremes();
                        e = c.dataMax;
                        c = c.dataMin;
                        r(c) && r(e) && (a.dataMin = E(o(a.dataMin, c), c), a.dataMax = t(o(a.dataMax, e), e));
                        r(d) && (a.dataMin >= d ? (a.dataMin = d, a.ignoreMinPadding = !0) : d > a.dataMax && (a.dataMax = d, 
        ...
        translate: function(a, b, c, d, e, f) {
            ...
            "between" === f && (f = .5), a = g * (a - d) * i + h + g * j + (ya(f) ? i * f * this.pointRange : 0));
            return a;
        },
        ...
        getPlotLinePath: function(a, b, c, d, e) {
            var i, j, m, f = this.chart, g = this.left, h = this.top, k = c && f.oldChartHeight || f.chartHeight, l = c && f.oldChartWidth || f.chartWidth;
            i = this.transB;
            e = o(e, this.translate(a, null, null, c));
            a = c = v(e + i);
            i = j = v(k - e - i);
            isNaN(e) ? m = !0 : this.horiz ? (i = h, j = k - this.bottom, g > a || a > g + this.width) && (m = !0) : (a = g, 
            c = l - this.right, h > i || i > h + this.height) && (m = !0);
            return m && !d ? null : f.renderer.crispLine([ "M", a, i, "L", c, j ], b || 1);
        },
        getLinearTickPositions: function(a, b, c) {
            for (var d, b = aa(S(b / a) * a), c = aa(Ka(c / a) * a), e = []; c >= b; ) {
                e.push(b);
                b = aa(b + a);
                if (b === d) break;
                d = b;
        ...
        getMinorTickPositions: function() {
            ...
            if (this.isLog) {
                e = b.length;
                for (a = 1; e > a; a++) d = d.concat(this.getLogTickPositions(c, b[a - 1], b[a], !0));
            } else if (this.isDatetimeAxis && "auto" === a.minorTickInterval) d = d.concat(this.getTimeTicks(this.normalizeTimeTickInterval(c), this.min, this.max, a.startOfWeek)), 
            d[0] < this.min && d.shift(); else for (b = this.min + (b[0] - this.min) % c; this.max >= b; b += c) d.push(b);
            return d;
        },
        adjustForMinRange: function() {
            var d, f, g, h, i, j, a = this.options, b = this.min, c = this.max, e = this.dataMax - this.dataMin >= this.minRange;
            this.isXAxis && this.minRange === u && !this.isLog && (r(a.min) || r(a.max) ? this.minRange = null : (p(this.series, function(a) {
                i = a.xData;
                for (g = j = a.xIncrement ? 1 : i.length - 1; g > 0; g--) (h = i[g] - i[g - 1], 
                f === u || f > h) && (f = h);
            }), this.minRange = E(5 * f, this.dataMax - this.dataMin)));
            if (this.minRange > c - b) {
                var k = this.minRange;
                d = (k - c + b) / 2;
                d = [ b - d, o(a.min, b - d) ];
                e && (d[2] = this.dataMin);
                ...
                e && (c[2] = this.dataMax);
                c = Na(c);
                k > c - b && (d[0] = c - k, d[1] = o(a.min, c - k), b = Ba(d));
            }
            this.min = b;
            this.max = c;
        },
        setAxisTranslation: function(a) {
            ...
            b.pointRangePadding = g *= h, b.pointRange = E(d, c), b.closestPointRange = e);
            a && (b.oldTransA = j);
        ...
        setTickPositions: function(a) {
            var q, b = this, c = b.chart, d = b.options, e = b.isLog, f = b.isDatetimeAxis, g = b.isXAxis, h = b.isLinked, i = b.options.tickPositioner, j = d.maxPadding, k = d.minPadding, l = d.tickInterval, m = d.minTickInterval, n = d.tickPixelInterval, qa = b.categories;
            h ? (b.linkedParent = c[b.coll][d.linkedTo], c = b.linkedParent.getExtremes(), b.min = o(c.min, c.dataMin), 
            b.max = o(c.max, c.dataMax), d.type !== b.linkedParent.options.type && oa(11, 1)) : (b.min = o(b.userMin, d.min, b.dataMin), 
            b.max = o(b.userMax, d.max, b.dataMax));
            e && (!a && 0 >= E(b.min, o(b.dataMin, b.min)) && oa(10, 1), b.min = aa(za(b.min)), 
            b.max = aa(za(b.max)));
            ...
            if (!qa && !b.axisPointRange && !b.usePercentage && !h && r(b.min) && r(b.max) && (c = b.max - b.min)) {
                r(d.min) || r(b.userMin) || !k || !(0 > b.dataMin) && b.ignoreMinPadding || (b.min -= c * k);
                r(d.max) || r(b.userMax) || !j || !(b.dataMax > 0) && b.ignoreMaxPadding || (b.max += c * j);
            }
            b.min === b.max || void 0 === b.min || void 0 === b.max ? b.tickInterval = 1 : h && !l && n === b.linkedParent.options.tickPixelInterval ? b.tickInterval = b.linkedParent.tickInterval : (b.tickInterval = o(l, qa ? 1 : (b.max - b.min) * n / t(b.len, n)), 
            !r(l) && n > b.len && !this.isRadial && !this.isLog && !qa && d.startOnTick && d.endOnTick && (q = !0, 
            b.tickInterval /= 4));
            ...
            !l && m > b.tickInterval && (b.tickInterval = m);
            ...
            a || (!b.ordinalPositions && (b.max - b.min) / b.tickInterval > t(2 * b.len, 200) && oa(19, !0), 
            ...
            q && a.splice(1, a.length - 2), b.tickPositions = a);
            h || (e = a[0], f = a[a.length - 1], h = b.minPointOffset || 0, d.startOnTick ? b.min = e : b.min - h > e && a.shift(), 
            d.endOnTick ? b.max = f : f > b.max + h && a.pop(), 1 === a.length && (d = .001 * N(b.max || 1), 
            b.min -= d, b.max += d));
        },
        ...
        adjustTickAmount: function() {
            ...
            if (c && c[a] && !this.isDatetimeAxis && !this.categories && !this.isLinked && this.options.alignTicks !== !1 && this.min !== u) {
                ...
                if (a > e) {
                    for (;a > b.length; ) b.push(aa(b[b.length - 1] + this.tickInterval));
                    this.transA *= (e - 1) / (a - 1);
        ...
        zoom: function(a, b) {
            ...
            this.allowZoomOutside || (r(c) && E(c, o(e.min, c)) >= a && (a = u), r(d) && b >= t(d, o(e.max, d)) && (b = u));
        ...
        autoLabelAlign: function(a) {
            a = (o(a, 0) - 90 * this.side + 720) % 360;
            return a > 15 && 165 > a ? "right" : a > 195 && 345 > a ? "left" : "center";
        },
        getOffset: function() {
            var j, l, v, y, z, H, A, a = this, b = a.chart, c = b.renderer, d = a.options, e = a.tickPositions, f = a.ticks, g = a.horiz, h = a.side, i = b.inverted ? [ 1, 0, 3, 2 ][h] : h, k = 0, m = 0, n = d.title, q = d.labels, qa = 0, K = b.axisOffset, s = b.clipOffset, P = [ -1, 1, 1, -1 ][h], w = 1, x = o(q.maxStaggerLines, 5);
            ...
            if (j || a.isLinked) {
                ...
                if (a.horiz && !a.staggerLines && x && !q.rotation) {
                    for (v = a.reversed ? [].concat(e).reverse() : e; x > w; ) {
                        j = [];
                        y = !1;
                        for (q = 0; v.length > q; q++) z = v[q], H = (H = f[z].label && f[z].label.getBBox()) ? H.width : 0, 
                        A = q % w, H && (z = a.translate(z), j[A] !== u && j[A] > z && (y = !0), j[A] = z + H);
                        if (!y) break;
                        w++;
                    }
                    w > 1 && (a.staggerLines = w);
                }
                p(e, function(b) {
                    (0 === h || 2 === h || {
                        1: "left",
                ...
                a.staggerLines && (qa *= a.staggerLines, a.labelOffset = qa);
            } else for (v in f) f[v].destroy(), delete f[v];
            if (n && n.text && n.enabled !== !1) {
                a.axisTitle || (a.axisTitle = c.text(n.text, 0, 0, n.useHTML).attr({
                    zIndex: 7,
                ...
                a.axisTitle.isNew = !0);
                b && (k = a.axisTitle.getBBox()[g ? "height" : "width"], m = o(n.margin, g ? 5 : 10), 
                l = n.offset);
                a.axisTitle[b ? "show" : "hide"]();
            }
            a.offset = P * o(d.offset, K[h]);
            a.axisTitleMargin = o(l, qa + m + (2 !== h && qa && P * d.labels[g ? "y" : "x"]));
            K[h] = t(K[h], a.axisTitleMargin + k + P * a.offset);
            s[i] = t(s[i], 2 * S(d.lineWidth / 2));
        },
        ...
        render: function() {
            var j, x, H, a = this, b = a.horiz, c = a.reversed, d = a.chart, e = d.renderer, f = a.options, g = a.isLog, h = a.isLinked, i = a.tickPositions, k = a.axisTitle, l = a.ticks, m = a.minorTicks, n = a.alternateBands, q = f.stackLabels, o = f.alternateGridColor, K = a.tickmarkOffset, t = f.lineWidth, v = d.hasRendered && r(a.oldMin) && !isNaN(a.oldMin), s = a.hasData, w = a.showAxis, y = f.labels.overflow, z = a.justifyLabels = b && y !== !1;
            a.labelEdge.length = 0;
            a.justifyToPlot = "justify" === y;
            p([ l, m, n ], function(a) {
                for (var b in a) a[b].isActive = !1;
            });
            (s || h) && ((a.minorTickInterval && !a.categories && p(a.getMinorTickPositions(), function(b) {
                m[b] || (m[b] = new Sa(a, b, "minor"));
                v && m[b].isNew && m[b].render(null, !0);
                m[b].render(null, !1, 1);
            }), i.length && (j = i.slice(), (b && c || !b && !c) && j.reverse(), z && (j = j.slice(1).concat([ j[0] ])), 
            p(j, function(b, c) {
                z && (c = c === j.length - 1 ? 0 : c + 1);
                (!h || b >= a.min && a.max >= b) && (l[b] || (l[b] = new Sa(a, b)), v && l[b].isNew && l[b].render(c, !0, .1), 
                l[b].render(c, !1, 1));
            }), K && 0 === a.min && (l[-1] || (l[-1] = new Sa(a, -1, null, !0)), l[-1].render(-1))), 
            o && p(i, function(b, c) {
                0 === c % 2 && a.max > b && (n[b] || (n[b] = new Q.PlotLineOrBand(a)), x = b + K, 
                H = i[c + 1] !== u ? i[c + 1] + K : a.max, n[b].options = {
                    from: g ? ha(x) : x,
                    to: g ? ha(H) : H,
                    color: o
            ...
            k && w && (k[k.isNew ? "attr" : "animate"](a.getTitlePosition()), k.isNew = !1);
        ...
        drawCrosshair: function(a, b) {
            if (this.crosshair) if ((r(b) || !o(this.crosshair.snap, !0)) === !1) this.hideCrosshair(); else {
                ...
                if (null === c) this.hideCrosshair(); else if (this.cross) this.cross.attr({
                    visibility: "visible"
                })[e ? "animate" : "attr"]({
                    d: c
                }, e); else {
    ...
    ka.prototype.getTimeTicks = function(a, b, c, d) {
        var h, e = [], f = {}, g = L.global.useUTC, i = new Date(b - Ra), j = a.unitRange, k = a.count;
        if (r(b)) {
            j >= B.second && (i.setMilliseconds(0), i.setSeconds(j >= B.minute ? 0 : k * S(i.getSeconds() / k)));
            j >= B.minute && i[Db](j >= B.hour ? 0 : k * S(i[pb]() / k));
            j >= B.hour && i[Eb](j >= B.day ? 0 : k * S(i[qb]() / k));
            j >= B.day && i[sb](j >= B.month ? 1 : k * S(i[Xa]() / k));
            j >= B.month && (i[Fb](j >= B.year ? 0 : k * S(i[eb]() / k)), h = i[fb]());
            j >= B.year && (h -= h % k, i[Gb](h));
            j === B.week && i[sb](i[Xa]() - i[rb]() + o(d, 1));
            b = 1;
            Ra && (i = new Date(i.getTime() + Ra));
            h = i[fb]();
            for (var d = i.getTime(), l = i[eb](), m = i[Xa](), n = g ? Ra : (864e5 + 6e4 * i.getTimezoneOffset()) % 864e5; c > d; ) e.push(d), 
            j === B.year ? d = db(h + b * k, 0) : j === B.month ? d = db(h, l + b * k) : g || j !== B.day && j !== B.week ? d += j * k : d = db(h, l, m + b * k * (j === B.day ? 1 : 7)), 
            b++;
            e.push(d);
            p(vb(e, function(a) {
                return B.hour >= j && a % B.day === n;
            }), function(a) {
                f[a] = "day";
            });
        }
    ...
    ka.prototype.normalizeTimeTickInterval = function(a, b) {
        var g, c = b || [ [ "millisecond", [ 1, 2, 5, 10, 20, 25, 50, 100, 200, 500 ] ], [ "second", [ 1, 2, 5, 10, 15, 30 ] ], [ "minute", [ 1, 2, 5, 10, 15, 30 ] ], [ "hour", [ 1, 2, 3, 4, 6, 8, 12 ] ], [ "day", [ 1, 2 ] ], [ "week", [ 1, 2 ] ], [ "month", [ 1, 2, 3, 4, 6 ] ], [ "year", null ] ], d = c[c.length - 1], e = B[d[0]], f = d[1];
        for (g = 0; c.length > g; g++) if (d = c[g], e = B[d[0]], f = d[1], c[g + 1] && (e * f[f.length - 1] + B[c[g + 1][0]]) / 2 >= a) break;
        e === B.year && 5 * e > a && (f = [ 1, 2, 5 ]);
        c = nb(a / e, f, "year" === d[0] ? t(mb(a / e), 1) : 1);
        return {
            unitRange: e,
            count: c,
            unitName: d[0]
    ...
    ka.prototype.getLogTickPositions = function(a, b, c, d) {
        ...
        if (a >= .5) a = v(a), g = this.getLinearTickPositions(a, b, c); else if (a >= .08) for (var h, i, j, k, l, f = S(b), e = a > .3 ? [ 1, 2, 4 ] : a > .15 ? [ 1, 2, 4, 6, 8 ] : [ 1, 2, 3, 4, 5, 6, 7, 8, 9 ]; c + 1 > f && !l; f++) {
            i = e.length;
            for (h = 0; i > h && !l; h++) j = za(ha(f) * e[h]), j > b && (!d || c >= k) && g.push(k), 
            k > c && (l = !0), k = j;
        } else (b = ha(b), c = ha(c), a = e[d ? "minorTickInterval" : "tickInterval"], a = o("auto" === a ? null : a, this._minorAutoInterval, (c - b) * (e.tickPixelInterval / (d ? 5 : 1)) / ((d ? f / this.tickPositions.length : f) || 1)), 
    ...
    Nb.prototype = {
        ...
        move: function(a, b, c, d) {
            ...
            e.label.attr(f);
            g && (N(a - f.x) > 1 || N(b - f.y) > 1) && (clearTimeout(this.tooltipTimeout), this.tooltipTimeout = setTimeout(function() {
                e && e.move(a, b, c, d);
            }, 32));
        },
        hide: function() {
        ...
        getAnchor: function(a, b) {
            var c, i, d = this.chart, e = d.inverted, f = d.plotTop, g = 0, h = 0, a = na(a);
            c = a[0].tooltipPos;
        ...
        getPosition: function(a, b, c) {
            var l, d = this.chart, e = d.plotLeft, f = d.plotTop, g = d.plotWidth, h = d.plotHeight, i = o(this.options.distance, 12), j = isNaN(c.plotX) ? 0 : c.plotX, c = c.plotY, d = j + e + (d.inverted ? i : -a - i), k = c - b + f + 15;
            7 > d && (d = e + t(j, 0) + i);
        ...
        defaultFormatter: function(a) {
            var d, b = this.points || na(this), c = b[0].series;
        ...
        refresh: function(a, b) {
            ...
            i = i.call(h, this);
            h = a.series;
            i === !1 ? this.hide() : (this.isHidden && (ab(d), d.attr("opacity", 1).show()), 
            d.attr({
                text: i
        ...
        tooltipHeaderFormatter: function(a) {
            var h, b = a.series, c = b.tooltipOptions, d = c.dateTimeLabelFormats, e = c.xDateFormat, f = b.xAxis, g = f && "datetime" === f.options.type && ya(a.key), c = c.headerFormat, f = f && f.closestPointRange;
            if (g && !e) {
                if (f) {
                    for (h in B) if (B[h] >= f || B[h] <= B.day && a.key % B[h] > 0) {
                        e = d[h];
                        break;
                    }
                } else e = d.day;
    ...
    Wa.prototype = {
        init: function(a, b) {
            var f, c = b.chart, d = c.events, e = ca ? "" : c.zoomType, c = a.inverted;
            this.options = b;
            this.chart = a;
            ...
            this.pinchDown = [];
            this.lastValidTouch = {};
            Q.Tooltip && b.tooltip.enabled && (a.tooltip = new Nb(a, b.tooltip));
            this.setDOMEvents();
        },
        ...
        runPointActions: function(a) {
            ...
            if (d && this.options.tooltip.shared && (!h || !h.noSharedTooltip)) {
                f = [];
                i = c.length;
                for (j = 0; i > j; j++) c[j].visible && c[j].options.enableMouseTracking !== !1 && !c[j].noSharedTooltip && c[j].singularTooltips !== !0 && c[j].tooltipPoints.length && (e = c[j].tooltipPoints[l]) && e.series && (e._dist = N(l - e.clientX), 
                k = E(k, e._dist), f.push(e));
                for (i = f.length; i--; ) f[i]._dist > k && f.splice(i, 1);
                f.length && f[0].clientX !== this.hoverX && (d.refresh(f, a), this.hoverX = f[0].clientX);
            }
            !h || !h.tracker || d && d.followPointer ? d && d.followPointer && !d.isHidden && (c = d.getAnchor([ {} ], a), 
            d.updatePosition({
                plotX: c[0],
                plotY: c[1]
            })) : (e = h.tooltipPoints[l]) && e !== g && e.onMouseOver(a);
            d && !this._onDocumentMouseMove && (this._onDocumentMouseMove = function(a) {
                r(fa) && Y[fa].pointer.onDocumentMouseMove(a);
        ...
        reset: function(a) {
            ...
            if (a) e.refresh(f), d && d.setState(d.state, !0); else {
                ...
                c && c.onMouseOut();
                e && e.hide();
                this._onDocumentMouseMove && (U(y, "mousemove", this._onDocumentMouseMove), this._onDocumentMouseMove = null);
                p(b.axes, function(a) {
                    a.hideCrosshair();
                });
                this.hoverX = null;
        ...
        drag: function(a) {
            var l, b = this.chart, c = b.options.chart, d = a.chartX, e = a.chartY, f = this.zoomHor, g = this.zoomVert, h = b.plotLeft, i = b.plotTop, j = b.plotWidth, k = b.plotHeight, m = this.mouseDownX, n = this.mouseDownY;
            h > d ? d = h : d > h + j && (d = h + j);
            i > e ? e = i : e > i + k && (e = i + k);
        ...
        onContainerClick: function(a) {
            ...
            a.cancelBubble = !0;
            b.cancelClick || (c && this.inClass(a.target, "highcharts-tracker") ? (g = this.chartPosition, 
    ...
    s(Q.Pointer.prototype, {
        ...
        pinchTranslateDirection: function(a, b, c, d, e, f, g, h) {
            var q, o, y, i = this.chart, j = a ? "x" : "y", k = a ? "X" : "Y", l = "chart" + k, m = a ? "width" : "height", n = i["plot" + (a ? "Left" : "Top")], p = h || 1, t = i.inverted, r = i.bounds[a ? "h" : "v"], v = 1 === b.length, s = b[0][l], u = c[0][l], w = !v && b[1][l], x = !v && c[1][l], c = function() {
            ...
            c();
            b = o;
            r.min > b ? (b = r.min, y = !0) : b + q > r.max && (b = r.max - q, y = !0);
            y ? (u -= .8 * (u - g[j][0]), v || (x -= .8 * (x - g[j][1])), c()) : g[j] = [ u, x ];
            t || (f[j] = o - n, f[m] = q);
            f = t ? 1 / p : p;
            e[m] = q;
            e[j] = b;
        ...
        pinch: function(a) {
            var b = this, c = b.chart, d = b.pinchDown, e = c.tooltip && c.tooltip.options.followTouchMove, f = a.touches, g = f.length, h = b.lastValidTouch, i = b.zoomHor || b.pinchHor, j = b.zoomVert || b.pinchVert, k = i || j, l = b.selectionMarker, m = {}, n = 1 === g && (b.inClass(a.target, "highcharts-tracker") && c.runTrackerClick || c.runChartClick), q = {};
            (k || e) && !n && a.preventDefault();
            Ua(f, function(a) {
                return b.normalize(a);
            });
            if ("touchstart" === a.type) p(f, function(a, b) {
                d[b] = {
                    chartX: a.chartX,
                    chartY: a.chartY
                };
            ...
            p(c.axes, function(a) {
                ...
                l || (b.selectionMarker = l = s({
                    destroy: Ea
                }, c.plotBox));
                b.pinchTranslate(i, j, d, f, m, l, q, h);
                b.hasPinched = k;
                b.scaleGroups(m, q);
                !k && e && 1 === g && this.runPointActions(b.normalize(a));
            }
        },
    ...
    if (G.PointerEvent || G.MSPointerEvent) {
        var ra = {}, zb = !!G.PointerEvent, Wb = function() {
            ...
            a = a.originalEvent || a;
            "touch" !== a.pointerType && a.pointerType !== a.MSPOINTER_TYPE_TOUCH || !Y[fa] || (d(a), 
            d = Y[fa].pointer, d[b]({
                type: c,
        ...
        s(Wa.prototype, {
            ...
            onContainerPointerMove: function(a) {
                Ab(a, "onContainerTouchMove", "touchmove", function(a) {
                    ...
                    ra[a.pointerId].target || (ra[a.pointerId].target = a.currentTarget);
                });
            },
    ...
    lb.prototype = {
        init: function(a, b) {
            ...
            this.options = b;
            b.enabled && (c.baseline = x(d.fontSize) + 3 + f, c.itemStyle = d, c.itemHiddenStyle = w(d, b.itemHiddenStyle), 
            c.itemMarginTop = f, c.padding = e, c.initialItemX = e, c.initialItemY = e - 5, 
            c.maxItemWidth = 0, c.chart = a, c.itemHeight = 0, c.lastLineHeight = 0, c.symbolWidth = o(b.symbolWidth, 16), 
            c.pages = [], c.render(), C(c.chart, "endResize", function() {
        ...
        renderItem: function(a) {
            ...
            r || (a.legendGroup = c.g("legend-item").attr({
                ...
                align: l ? "left" : "right",
                zIndex: 2
            }).add(a.legendGroup), this.setItemEvents && this.setItemEvents(a, r, x, h, i), 
            this.colorizeItem(a, a.visible), u && this.createCheckboxForItem(a));
            c = r.getBBox();
            f = a.legendItemWidth = d.itemWidth || a.legendItemWidth || f + g + c.width + k + (u ? 20 : 0);
            this.itemHeight = g = v(a.legendItemHeight || c.height);
            e && this.itemX - p + f > (m || b.chartWidth - 2 * j - p - d.x) && (this.itemX = p, 
            this.itemY += q + this.lastLineHeight + n, this.lastLineHeight = 0);
        ...
        getAllItems: function() {
            ...
            p(this.chart.series, function(b) {
                var c = b.options;
                o(c.showInLegend, r(c.linkedTo) ? !1 : u, !0) && (a = a.concat(b.legendItems || ("point" === c.legendType ? b.data : b)));
            });
            return a;
        },
        render: function() {
        ...
        handleOverflow: function(a) {
            var h, q, b = this, c = this.chart, d = c.renderer, e = this.options, f = e.y, f = c.spacingBox.height + ("top" === e.verticalAlign ? -f : f) - this.padding, g = e.maxHeight, i = this.clipRect, j = e.navigation, k = o(j.animation, !0), l = j.arrowSize || 12, m = this.nav, n = this.pages, t = this.allItems;
            ...
            if (a > f && !e.useHTML) {
                ...
                p(t, function(a, b) {
                    ...
                    (!e || c - n[e - 1] > h && (q || c) !== n[e - 1]) && (n.push(q || c), e++);
        ...
        scroll: function(a, b) {
            ...
            e > d && (e = d);
            e > 0 && (b !== u && Qa(b, this.chart), this.nav.attr({
                translateX: j,
    ...
    F = Q.LegendSymbolMixin = {
        ...
        drawLineMarker: function(a) {
            ...
            d = a.symbolWidth;
            var g, e = this.chart.renderer, f = this.legendGroup, a = a.baseline - v(.3 * e.fontMetrics(a.options.itemStyle.fontSize).b);
            if (b.lineWidth) {
                g = {
            ...
            c && c.enabled && (b = c.radius, this.legendSymbol = d = e.symbol(this.symbol, d / 2 - b, a - b, 2 * b, 2 * b).add(f), 
            d.isMarker = !0);
        }
    };
    ...
    Ya.prototype = {
        ...
        isInsidePlot: function(a, b, c) {
            var d = c ? b : a, a = c ? a : b;
            return d >= 0 && this.plotWidth >= d && a >= 0 && this.plotHeight >= a;
        },
        ...
        redraw: function(a) {
            var g, h, b = this.axes, c = this.series, d = this.pointer, e = this.legend, f = this.isDirtyLegend, i = this.isDirtyBox, j = c.length, k = j, l = this.renderer, m = l.isHidden(), n = [];
            Qa(a, this);
            ...
            if (this.hasCartesianSeries) {
                this.isResizing || (this.maxTicks = null, p(b, function(a) {
                    a.setScale();
                }));
        ...
        get: function(a) {
            ...
            for (d = 0; b.length > d; d++) if (b[d].options.id === a) return b[d];
            for (d = 0; c.length > d; d++) if (c[d].options.id === a) return c[d];
            for (d = 0; c.length > d; d++) {
                e = c[d].points || [];
                for (b = 0; e.length > b; b++) if (e[b].id === a) return e[b];
            }
            return null;
        },
        getAxes: function() {
        ...
        layOutTitles: function(a) {
            ...
            this.titleOffset = b;
            !this.isDirtyBox && c && (this.isDirtyBox = c, this.hasRendered && o(a, !0) && this.isDirtyBox && this.redraw());
        },
        getChartSize: function() {
            var a = this.options.chart, b = a.width, a = a.height, c = this.renderToClone || this.renderTo;
            r(b) || (this.containerWidth = ib(c, "width"));
            r(a) || (this.containerHeight = ib(c, "height"));
        ...
        cloneRenderTo: function(a) {
            ...
            this.renderToClone = b = this.renderTo.cloneNode(0), D(b, {
                position: "absolute",
                top: "-9999px",
                display: "block"
        ...
        getContainer: function() {
            ...
            e = "highcharts-" + tb++;
            ga(a) && (this.renderTo = a = y.getElementById(a));
            a || oa(13, !0);
        ...
        getMargins: function() {
            var b, a = this.spacing, c = this.legend, d = this.margin, e = this.options.legend, f = o(e.margin, 10), g = e.x, h = e.y, i = e.align, j = e.verticalAlign, k = this.titleOffset;
            this.resetMargins();
            b = this.axisOffset;
            k && !r(d[0]) && (this.plotTop = t(this.plotTop, k + this.options.title.margin + a[0]));
            c.display && !e.floating && ("right" === i ? r(d[1]) || (this.marginRight = t(this.marginRight, c.legendWidth - g + f + a[1])) : "left" === i ? r(d[3]) || (this.plotLeft = t(this.plotLeft, c.legendWidth + g + f + a[3])) : "top" === j ? r(d[0]) || (this.plotTop = t(this.plotTop, c.legendHeight + h + f + a[0])) : "bottom" !== j || r(d[2]) || (this.marginBottom = t(this.marginBottom, c.legendHeight - h + f + a[2])));
        ...
        setSize: function(a, b, c) {
            ...
            r(a) && (d.chartWidth = e = t(0, v(a)), d.hasUserSize = !!e);
            r(b) && (d.chartHeight = f = t(0, v(b)));
            (sa ? jb : D)(d.container, {
                width: e + "px",
                height: f + "px"
            }, sa);
        ...
        drawChartBox: function() {
            ...
            k && (f ? f.animate(r) : this.plotBackground = b.rect(q, o, p, t, 0).attr({
                fill: k
            }).add().shadow(a.plotShadow));
            l && (h ? h.animate(r) : this.plotBGImage = b.image(l, q, o, p, t).add());
            s ? s.animate({
                width: v.width,
                height: v.height
            }) : this.clipRect = b.clipRect(v);
            m && (g ? g.animate(g.crisp({
                x: q,
                y: o,
                width: p,
                height: t
        ...
        destroy: function() {
            ...
            d && (d.innerHTML = "", U(d), f && Pa(d));
            for (e in a) delete a[e];
        },
        isReadyToRender: function() {
            var a = this;
            return !X && G == G.top && "complete" !== y.readyState || ca && !G.canvg ? (ca ? Mb.push(function() {
                a.firstRender();
        ...
        firstRender: function() {
            ...
            if (a.isReadyToRender()) {
                ...
                a.linkSeries();
                I(a, "beforeRender");
                Q.Pointer && (a.pointer = new Wa(a, b));
                a.render();
                a.renderer.draw();
                c && c.apply(a, [ a ]);
    ...
    da = Q.CenteredSeriesMixin = {
        getCenter: function() {
            var d, h, a = this.options, b = this.chart, c = 2 * (a.slicedOffset || 0), e = b.plotWidth - 2 * c, f = b.plotHeight - 2 * c, b = a.center, a = [ o(b[0], "50%"), o(b[1], "50%"), a.size || "100%", a.innerSize || 0 ], g = E(e, f);
    ...
    Fa.prototype = {
        ...
        destroy: function() {
            ...
            (this.graphic || this.dataLabel) && (U(this), this.destroyElements());
    ...
    M.prototype = {
        ...
        bindAxes: function() {
            ...
            p(a.axisTypes || [], function(e) {
                p(c[e], function(c) {
                    d = c.options;
                    (b[e] === d.index || b[e] !== u && b[e] === d.id || b[e] === u && 0 === d.index) && (c.series.push(a), 
                    a[e] = c, c.isDirty = !0);
                });
        ...
        getColor: function() {
            ...
            e || a.colorByPoint || (r(b._colorIndex) ? a = b._colorIndex : (b._colorIndex = d.color, 
            a = d.color++), e = c[a]);
            this.color = e;
        ...
        getSymbol: function() {
            ...
            this.symbol || (r(a._symbolIndex) ? a = a._symbolIndex : (a._symbolIndex = c.symbol, 
        ...
        setData: function(a, b, c, d) {
            var h, e = this, f = e.points, g = f && f.length || 0, i = e.options, j = e.chart, k = null, l = e.xAxis, m = l && !!l.categories, n = e.tooltipPoints, q = i.turboThreshold, t = this.xData, r = this.yData, s = (h = e.pointArrayMap) && h.length, a = a || [];
            h = a.length;
            b = o(b, !0);
            if (d === !1 || !h || g !== h || e.cropped || e.hasGroupedData) {
                ...
                if (q && h > q) {
                    ...
                    if (ya(k)) {
                        ...
                        for (c = 0; h > c; c++) t[c] = m, r[c] = a[c], m += i;
                        e.xIncrement = m;
                    } else if (La(k)) if (s) for (c = 0; h > c; c++) i = a[c], t[c] = i[0], r[c] = i.slice(1, s + 1); else for (c = 0; h > c; c++) i = a[c], 
                    t[c] = i[0], r[c] = i[1]; else oa(12);
        ...
        processData: function(a) {
            ...
            k && this.sorted && (!j || d > j || this.forceCrop) && (a = h.min, h = h.max, a > b[d - 1] || b[0] > h ? (b = [], 
            c = []) : (a > b[0] || b[d - 1] > h) && (e = this.cropData(this.xData, this.yData, a, h), 
            b = e.xData, c = e.yData, e = e.start, f = !0));
            for (h = b.length - 1; h >= 0; h--) d = b[h] - b[h - 1], d > 0 && (g === u || g > d) ? g = d : 0 > d && this.requireSorting && oa(15);
            this.cropped = f;
            this.cropStart = e;
        ...
        cropData: function(a, b, c, d) {
            var i, e = a.length, f = 0, g = e, h = o(this.cropShoulder, 1);
        ...
        generatePoints: function() {
            ...
            for (m = 0; g > m; m++) i = h + m, j ? l[m] = new f().init(this, [ d[m] ].concat(na(e[m]))) : (b[i] ? k = b[i] : a[i] !== u && (b[i] = k = new f().init(this, a[i], d[m])), 
            l[m] = k);
            if (b && (g !== (c = b.length) || j)) for (m = 0; c > m; m++) (m === h && !j && (m += g), 
            b[m]) && (b[m].destroyElements(), b[m].plotX = u);
            this.data = b;
            this.points = l;
        },
        getExtremes: function(a) {
            ...
            d = a.length;
            for (l = 0; d > l; l++) if (j = c[l], k = a[l], i = null !== k && k !== u && (!b.isLog || k.length || k > 0), 
            j = this.getExtremesFromAll || this.cropped || (c[l + 1] || j) >= g && h >= (c[l - 1] || j), 
        ...
        translate: function() {
            ...
            this.generatePoints();
            for (var a = this.options, b = a.stacking, c = this.xAxis, d = c.categories, e = this.yAxis, f = this.points, g = f.length, h = !!this.modifyValue, i = a.pointPlacement, j = "between" === i || ya(i), k = a.threshold, a = 0; g > a; a++) {
                var l = f[a], m = l.x, n = l.y, q = l.low, p = b && e.stacks[(this.negStacks && k > n ? "-" : "") + this.stackKey];
                e.isLog && 0 >= n && (l.y = n = null);
                l.plotX = c.translate(m, 0, 0, 0, 1, i, "flags" === this.type);
                b && this.visible && p && p[m] && (p = p[m], n = p.points[this.index], q = n[0], 
                n = n[1], 0 === q && (q = o(k, e.min)), e.isLog && 0 >= q && (q = null), l.total = l.stackTotal = p.total, 
                l.percentage = p.total && 100 * (l.y / p.total), l.stackY = n, p.setOffset(this.pointXOffset || 0, this.barW || 0));
                l.yBottom = r(q) ? e.translate(q, 0, 1, 0, 1) : null;
                h && (n = this.modifyValue(n, l));
                l.plotY = "number" == typeof n && 1/0 !== n ? e.translate(n, 0, 1, 0, 1) : u;
        ...
        drawPoints: function() {
            var a, d, e, f, g, h, i, j, k, n, b = this.points, c = this.chart, l = this.options.marker, m = this.pointAttr[""], q = this.markerGroup;
            if (l.enabled || this._hasPointMarkers) for (f = b.length; f--; ) g = b[f], d = S(g.plotX), 
            e = g.plotY, k = g.graphic, i = g.marker || {}, a = l.enabled && i.enabled === u || i.enabled, 
            n = c.isInsidePlot(v(d), e, c.inverted), a && e !== u && !isNaN(e) && null !== g.y ? (a = g.pointAttr[g.selected ? "select" : ""] || m, 
            h = a.r, i = o(i.symbol, this.symbol), j = 0 === i.indexOf("url"), k ? k.attr({
                ...
                width: 2 * h,
                height: 2 * h
            } : {})) : n && (h > 0 || j) && (g.graphic = c.renderer.symbol(i, d - h, e - h, 2 * h, 2 * h).attr(a).add(q))) : k && (g.graphic = k.destroy());
        },
        ...
        getAttribs: function() {
            var f, a = this, b = a.options, c = Z[a.type].marker ? b.marker : b, d = c.states, e = d.hover, g = a.color;
            f = {
                stroke: g,
                fill: g
            };
            ...
            if (!i || i > g || k) for (;g--; ) {
                i = h[g];
                (c = i.options && i.options.marker || i.options) && c.enabled === !1 && (c.radius = 0);
                i.negative && m && (i.color = i.fillColor = m);
                ...
                if (k) {
                    ...
                    d = c.states || {};
                    f = d.hover = d.hover || {};
                    b.marker || (f.color = f.color || !i.options.color && e.color || wa(i.color).brighten(f.brightness || e.brightness).get());
                    f = {
                        color: i.color
                    };
                    q || (f.fillColor = i.color);
                    n || (f.lineColor = i.color);
        ...
        destroy: function() {
            var d, e, g, h, i, a = this, b = a.chart, c = /AppleWebKit\/533/.test(ua), f = a.data || [];
            I(a, "destroy");
            U(a);
        ...
        invertGroups: function() {
            ...
            b.xAxis && (C(c, "resize", a), C(b, "destroy", function() {
                U(c, "resize", a);
            }), a(), b.invertGroups = a);
        },
    ...
    ka.prototype.buildStacks = function() {
        ...
        if (!this.isXAxis) {
            ...
            if (this.usePercentage) for (c = 0; a.length > c; c++) a[c].setPercentStacks();
        }
    };
    ...
    M.prototype.setStackedPoints = function() {
        if (this.options.stacking && !(this.visible !== !0 && this.chart.options.chart.ignoreHiddenSeries !== !1)) {
            var n, q, o, p, r, a = this.processedXData, b = this.processedYData, c = [], d = b.length, e = this.options, f = e.threshold, g = e.stack, e = e.stacking, h = this.stackKey, i = "-" + h, j = this.negStacks, k = this.yAxis, l = k.stacks, m = k.oldStacks;
            for (o = 0; d > o; o++) {
                p = a[o];
                r = b[o];
                q = (n = j && f > r) ? i : h;
                l[q] || (l[q] = {});
                l[q][p] || (m[q] && m[q][p] ? (l[q][p] = m[q][p], l[q][p].total = null) : l[q][p] = new Hb(k, k.options.stackLabels, n, p, g, e));
                q = l[q][p];
                q.points[this.index] = [ q.cum || 0 ];
                "percent" === e ? (n = n ? h : i, j && l[n] && l[n][p] ? (n = l[n][p], q.total = n.total = t(n.total, q.total) + N(r) || 0) : q.total = aa(q.total + (N(r) || 0))) : q.total = aa(q.total + (r || 0));
                q.cum = (q.cum || 0) + (r || 0);
    ...
    M.prototype.setPercentStacks = function() {
        ...
        p([ b, "-" + b ], function(b) {
            var e;
            for (var g, h, f = d.length; f--; ) (g = d[f], e = (h = c[b] && c[b][g]) && h.points[a.index], 
            g = e) && (h = h.total ? 100 / h.total : 0, g[0] = aa(g[0] * h), g[1] = aa(g[1] * h), 
    ...
    s(Fa.prototype, {
        update: function(a, b, c) {
            var g, d = this, e = d.series, f = d.graphic, h = e.data, i = e.chart, j = e.options, b = o(b, !0);
            d.firePointEvent("update", {
                ...
                if ($(a)) {
                    e.getAttribs();
                    f && (a && a.marker && a.marker.symbol ? d.graphic = f.destroy() : f.attr(d.pointAttr[d.state || ""]));
    ...
    s(M.prototype, {
        addPoint: function(a, b, c, d) {
            var m, e = this.options, f = this.data, g = this.graph, h = this.area, i = this.chart, j = this.xAxis && this.xAxis.names, k = g && g.shift || 0, l = e.data, n = this.xData;
            Qa(d, i);
            ...
            g = d.x;
            h = n.length;
            if (this.requireSorting && n[h - 1] > g) for (m = !0; h && n[h - 1] > g; ) h--;
        ...
        update: function(a, b) {
            var f, c = this.chart, d = this.type, e = J[d].prototype, a = w(this.userOptions, {
                animation: !1,
                index: this.index,
    ...
    var ma = ja(M, {
        type: "area",
        getSegments: function() {
            var h, i, l, m, n, a = [], b = [], c = [], d = this.xAxis, e = this.yAxis, f = e.stacks[this.stackKey], g = {}, j = this.points, k = this.options.connectNulls;
            if (this.options.stacking && !this.cropped) {
                for (m = 0; j.length > m; m++) g[j[m].x] = j[m];
        ...
        getSegmentPath: function(a) {
            var d, b = M.prototype.getSegmentPath.call(this, a), c = [].concat(b), e = this.options;
            d = b.length;
            ...
            a.length - 1 > d && e.step && c.push(a[d + 1].plotX, g), c.push(a[d].plotX, g); else this.closeSegment(c, a, f);
        ...
        drawGraph: function() {
            ...
            p(f, function(d) {
                ...
                f ? f.animate({
                    ...
                    fill: o(d[2], wa(d[1]).setOpacity(o(c.fillOpacity, .75)).get()),
                    zIndex: 0
                }).add(a.group);
            });
        },
    ...
    ea = ja(M, {
        ...
        getPointSpline: function(a, b, c) {
            ...
            if (f && g) {
                ...
                i += l;
                k += l;
                i > a && i > e ? (i = t(a, e), k = 2 * e - i) : a > i && e > i && (i = E(a, e), 
                k = 2 * e - i);
                k > g && k > e ? (k = t(g, e), i = 2 * e - k) : g > k && e > k && (k = E(g, e), 
                i = 2 * e - k);
                b.rightContX = j;
                b.rightContY = k;
            }
    ...
    ea = ja(M, {
        ...
        translate: function() {
            var a = this.chart, b = this.options, c = b.borderWidth, d = this.yAxis, e = this.translatedThreshold = d.getThreshold(b.threshold), f = o(b.minPointLength, 5), b = this.getColumnMetrics(), g = b.width, h = this.barW = Ka(t(g, 1 + 2 * c)), i = this.pointXOffset = b.offset, j = -(c % 2 ? .5 : 0), k = c % 2 ? .5 : 1;
            a.renderer.isVML && a.inverted && (k += 1);
            M.prototype.translate.apply(this);
            p(this.points, function(a) {
                var s, b = o(a.yBottom, e), c = E(t(-999 - b, a.plotY), d.len + 999 + b), q = a.plotX + i, p = h, r = E(c, b), c = t(c, b) - r;
                f > N(c) && f && (c = f, r = v(N(r - e) > f ? b - f : e - (e >= d.translate(a.y, 0, 1, 0, 1) ? f : 0)));
                a.barX = q;
                a.pointWidth = g;
                b = .5 > N(q);
                p = v(q + p) + j;
        ...
        drawGraph: Ea,
        drawPoints: function() {
            var e, a = this, b = a.options, c = this.chart.renderer, d = b.animationLimit || 250;
            p(a.points, function(f) {
                var g = f.plotY, h = f.graphic;
                g === u || isNaN(g) || null === f.y ? h && (f.graphic = h.destroy()) : (e = f.shapeArgs, 
                h ? (ab(h), h[d > a.points.length ? "animate" : "attr"](w(e))) : f.graphic = c[f.shapeType](e).attr(f.pointAttr[f.selected ? "select" : ""]).add(a.group).shadow(b.shadow, null, b.stacking && !b.borderRadius));
            });
        },
        animate: function(a) {
            var b = this.yAxis, c = this.options, d = this.chart.inverted, e = {};
            X && (a ? (e.scaleY = .001, a = E(b.pos + b.len, t(b.pos, b.toPixels(c.threshold))), 
    ...
    R = {
        ...
        generatePoints: function() {
            ...
            this.total = b;
            for (a = 0; d > a; a++) e = c[a], e.percentage = b > 0 ? 100 * (e.y / b) : 0, e.total = b;
        },
        translate: function(a) {
            this.generatePoints();
            var f, g, h, m, p, b = 0, c = this.options, d = c.slicedOffset, e = d + c.borderWidth, i = c.startAngle || 0, j = this.startAngleRad = la / 180 * (i - 90), i = (this.endAngleRad = la / 180 * (o(c.endAngle, i + 360) - 90)) - j, k = this.points, l = c.dataLabels.distance, c = c.ignoreHiddenPoint, n = k.length;
            ...
            for (m = 0; n > m; m++) {
                p = k[m];
                f = j + b * i;
                (!c || p.visible) && (b += p.percentage / 100);
                g = j + b * i;
                p.shapeType = "arc";
                p.shapeArgs = {
                    x: a[0],
                ...
                p.half = -la / 2 > h || h > la / 2 ? 1 : 0;
                p.angle = h;
                e = E(e, l / 2);
                p.labelPos = [ a[0] + f + W(h) * l, a[1] + g + ba(h) * l, a[0] + f + W(h) * e, a[1] + g + ba(h) * e, a[0] + f, a[1] + g, 0 > l ? "center" : p.half ? "right" : "left", h ];
            }
        },
        drawGraph: null,
        drawPoints: function() {
    ...
    M.prototype.drawDataLabels = function() {
        var e, f, g, h, a = this, b = a.options, c = b.cursor, d = b.dataLabels, b = a.points;
        ...
        f = d, p(b, function(b) {
            var j, l, m, k = b.dataLabel, n = b.connector, p = !0;
            ...
            if (k && !j) b.dataLabel = k.destroy(); else if (j) {
                ...
                if (k) r(g) ? (k.attr({
                    text: g
                }), p = !1) : (b.dataLabel = k = k.destroy(), n) && (b.connector = n.destroy()); else if (r(g)) {
                    k = {
    ...
    M.prototype.alignDataLabel = function(a, b, c, d, e) {
        ...
        (a = this.visible && (a.series.forceDL || f.isInsidePlot(h, v(i), g) || d && f.isInsidePlot(h, g ? d.x + 1 : d.y + d.height - 1, g))) && (d = s({
            x: g ? f.plotWidth - i : h,
    ...
    J.pie && (J.pie.prototype.drawDataLabels = function() {
        var c, i, j, s, u, w, x, z, B, E, H, A, a = this, b = a.data, d = a.chart, e = a.options.dataLabels, f = o(e.connectorPadding, 10), g = o(e.connectorWidth, 1), h = d.plotWidth, d = d.plotHeight, k = o(e.softConnector, !0), l = e.distance, m = a.center, n = m[2] / 2, q = m[1], r = l > 0, y = [ [], [] ], D = [ 0, 0, 0, 0 ], J = function(a, b) {
            return b.y - a.y;
        };
        if (a.visible && (e.enabled || a._hasPointLabels)) {
            ...
            H++;
            for (H = 2; H--; ) {
                var C, b = [], I = [], F = y[H], G = F.length;
                a.sortByAngle(F, H - .5);
                if (l > 0) {
                    for (A = q - n - l; q + n + l >= A; A += x) b.push(A);
                    u = b.length;
                    if (G > u) {
                        c = [].concat(F);
                        c.sort(J);
                    ...
                    for (A = 0; G > A; A++) {
                        ...
                        c = 9999;
                        var O, L;
                        for (L = 0; u > L; L++) O = N(b[L] - w[1]), c > O && (c = O, C = L);
                        if (A > C && null !== b[A]) C = A; else for (G - A + C > u && null !== b[A] && (C = u - G + A); null === b[C]; ) C++;
                        I.push({
                            i: C,
                            y: b[C]
                        });
                ...
                for (A = 0; G > A; A++) {
                    ...
                    c = w[1];
                    l > 0 ? (u = I.pop(), C = u.i, B = u.y, c > B && null !== b[C + 1] || B > c && null !== b[C - 1]) && (B = c) : B = c;
                    z = e.justify ? m[0] + (H ? -1 : 1) * (n + l) : a.getX(0 === C || C === b.length - 1 ? c : B, H);
                    s._attr = {
                        visibility: E,
                        align: w[6]
                    };
                    ...
                    s.connX = z;
                    s.connY = B;
                    null === this.options.size && (u = s.width, f > z - u ? D[3] = t(v(u - z + f), D[3]) : z + u > h - f && (D[1] = t(v(z + u - h + f), D[1])), 
                    0 > B - x / 2 ? D[0] = t(v(-B + x / 2), D[0]) : B + x / 2 > d && (D[2] = t(v(B + x / 2 - d), D[2])));
                }
            }
            (0 === Ba(D) || this.verifyDataLabelOverflow(D)) && (this.placeDataLabels(), r && g && p(this.points, function(b) {
                i = b.connector;
                w = b.labelPos;
                (s = b.dataLabel) && s._pos ? (E = s._attr.visibility, z = s.connX, B = s.connY, 
                j = k ? [ "M", z + ("left" === w[6] ? 5 : -5), B, "C", z, B, 2 * w[2] - w[4], 2 * w[3] - w[5], w[2], w[3], "L", w[4], w[5] ] : [ "M", z + ("left" === w[6] ? 5 : -5), B, "L", w[2], w[3], "L", w[4], w[5] ], 
                i ? (i.animate({
                    d: j
        ...
        b[0] += (a[3] - a[1]) / 2);
        null !== d[1] ? e = t(E(e, b[2] - t(a[0], a[2])), c) : (e = t(E(e, b[2] - a[0] - a[2]), c), 
        b[1] += (a[0] - a[2]) / 2);
        b[2] > e ? (b[2] = e, this.translate(b), p(this.points, function(a) {
    ...
    R = Q.TrackerMixin = {
        ...
        drawTrackerGraph: function() {
            ...
            }, o = "rgba(192,192,192," + (X ? 1e-4 : .002) + ")";
            if (e && !c) for (m = e + 1; m--; ) "M" === d[m] && d.splice(m + 1, 0, d[m + 1] - i, d[m + 2], "L"), 
            (m && "M" === d[m] || m === e) && d.splice(m, 0, "L", d[m - 2] + i, d[m - 1]);
            for (m = 0; k.length > m; m++) e = k[m], d.push("M", e.plotX - i, e.plotY, "L", e.plotX + i, e.plotY);
            j ? j.attr({
                d: d
    ...
    J.column && (ea.prototype.drawTracker = R.drawTrackerPoint);
    J.pie && (J.pie.prototype.drawTracker = R.drawTrackerPoint);
    J.scatter && (ma.prototype.drawTracker = R.drawTrackerPoint);
    s(lb.prototype, {
    ...
    s(Ya.prototype, {
        ...
        zoom: function(a) {
            ...
            d && !e ? this.showResetZoom() : !d && $(e) && (this.resetZoomButton = e.destroy());
            b && this.redraw(o(this.options.chart.animation, a && a.animation, 100 > this.pointCount));
        },
        pan: function(a, b) {
            ...
            p("xy" === b ? [ 1, 0 ] : [ 1 ], function(b) {
                ...
                h.series.length && l > E(k.dataMin, k.min) && t(k.dataMax, k.max) > i && (h.setExtremes(l, i, !1, !1, {
                    trigger: "pan"
                }), e = !0);
    ...
    s(Fa.prototype, {
        select: function(a, b) {
            ...
            c.firePointEvent(a ? "select" : "unselect", {
                ...
                b || p(e.getSelectedPoints(), function(a) {
                    a.selected && a !== c && (a.selected = a.options.selected = !1, d.options.data[va(a, d.data)] = a.options, 
        ...
        onMouseOut: function() {
            ...
            b && -1 !== va(this, b) || (this.firePointEvent("mouseOut"), this.setState(), a.hoverPoint = null);
        },
        ...
        setState: function(a, b) {
            ...
            if (!(a === this.state && !b || this.selected && "select" !== a || f[a] && f[a].enabled === !1 || a && (j || h && !i.enabled) || a && l.states && l.states[a] && l.states[a].enabled === !1)) {
    ...
    s(M.prototype, {
        ...
        setTooltipPoints: function(a) {
            ...
            if (!(this.options.enableMouseTracking === !1 || this.singularTooltips)) {
                ...
                a = b.length;
                for (i = 0; a > i; i++) if (e = b[i], c = e.x, c >= f.min && f.max >= c) {
                    h = b[i + 1];
                    c = d === u ? 0 : d + 1;
                    for (d = b[i + 1] ? E(t(0, S((e.clientX + (h ? h.wrappedClientX || h.clientX : g)) / 2)), g) : g; c >= 0 && d >= c; ) j[c++] = e;
                }
