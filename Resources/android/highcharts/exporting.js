(function(f) {
    ...
    p(A.prototype, {
        getSVG: function(b) {
            ...
            j.createElementNS || (j.createElementNS = function(a, b) {
        ...
        print: function() {
            ...
            b.isPrinting || (b.isPrinting = !0, r(h, function(a, b) {
        ...
        addButton: function(b) {
            ...
            if (c.enabled !== !1) {
                ...
                y += (e.width + c.buttonSpacing) * ("right" === c.align ? -1 : 1);
                a.exportSVGElements.push(e, g);
            }
        },
        destroyExport: function(b) {
            var a, d, b = b.target;
            for (a = 0; b.exportSVGElements.length > a; a++) (d = b.exportSVGElements[a]) && (d.onclick = d.ontouchstart = null, 
            b.exportSVGElements[a] = d.destroy());
            for (a = 0; b.exportDivElements.length > a; a++) d = b.exportDivElements[a], B(d, "mouseleave"), 
