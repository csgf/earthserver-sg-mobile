(function(a, b) {
    ...
    function cv(a) {
        if (!ck[a]) {
            ...
            if ("none" === e || "" === e) {
                ...
                b.appendChild(cl);
                cm && cl.createElement || (cm = (cl.contentWindow || cl.contentDocument).document, 
                cm.write(("CSS1Compat" === c.compatMode ? "<!doctype html>" : "") + "<html><body>"), 
                cm.close());
    ...
    function ca(a, b, c, d) {
        ...
        }); else if (c || null == b || "object" != typeof b) d(a, b); else for (var e in b) ca(a + "[" + e + "]", b[e], c, d);
    }
    function b_(a, c) {
    ...
    function b$(a, c, d, e, f, g) {
        ...
        var l, h = a[f], i = 0, j = h ? h.length : 0, k = a === bT;
        for (;j > i && (k || !l); i++) l = h[i](c, d, e), "string" == typeof l && (!k || g[l] ? l = b : (c.dataTypes.unshift(l), 
        l = b$(a, c, d, e, l, g)));
        (k || !l) && !g["*"] && (l = b$(a, c, d, e, "*", g));
        return l;
    }
    function bZ(a) {
        return function(b, c) {
            ...
            if (f.isFunction(c)) {
                var h, i, j, d = b.toLowerCase().split(bP), e = 0, g = d.length;
                for (;g > e; e++) h = d[e], j = /^\+/.test(h), j && (h = h.substr(1) || "*"), i = a[h] = a[h] || [], 
                i[j ? "unshift" : "push"](c);
            }
        };
    }
    function bC(a, b, c) {
        var d = "width" === b ? a.offsetWidth : a.offsetHeight, e = "width" === b ? bx : by, g = 0, h = e.length;
        if (d > 0) {
            if ("border" !== c) for (;h > g; g++) c || (d -= parseFloat(f.css(a, "padding" + e[g])) || 0), 
            "margin" === c ? d += parseFloat(f.css(a, c + e[g])) || 0 : d -= parseFloat(f.css(a, "border" + e[g] + "Width")) || 0;
            return d + "px";
        }
        d = bz(a, b, b);
        (0 > d || null == d) && (d = a.style[b] || 0);
        d = parseFloat(d) || 0;
        if (c) for (;h > g; g++) d += parseFloat(f.css(a, "padding" + e[g])) || 0, "padding" !== c && (d += parseFloat(f.css(a, "border" + e[g] + "Width")) || 0), 
        "margin" === c && (d += parseFloat(f.css(a, c + e[g])) || 0);
        return d + "px";
    }
    function bp(a, b) {
        b.src ? f.ajax({
    ...
    function bj(a, b) {
        if (1 === b.nodeType && !!f.hasData(a)) {
            ...
            if (i) {
                ...
                for (c in i) for (d = 0, e = i[c].length; e > d; d++) f.event.add(b, c + (i[c][d].namespace ? "." : "") + i[c][d].namespace, i[c][d], i[c][d].data);
            }
    ...
    function m(a) {
        for (var b in a) {
            if ("data" === b && f.isEmptyObject(a[b])) continue;
    ...
    function l(a, c, d) {
        if (d === b && 1 === a.nodeType) {
            ...
            if ("string" == typeof d) {
                try {
                    d = "true" === d ? !0 : "false" === d ? !1 : "null" === d ? null : f.isNumeric(d) ? parseFloat(d) : j.test(d) ? f.parseJSON(d) : d;
                } catch (g) {}
                f.data(a, c, d);
            } else d = b;
        }
    ...
    function h(a) {
        var c, d, b = g[a] = {};
        a = a.split(/\s+/);
        for (c = 0, d = a.length; d > c; c++) b[a[c]] = !0;
        return b;
    }
    var c = a.document, d = a.navigator, e = a.location, f = function() {
        ...
        }, f = a.jQuery, g = a.$, i = /^(?:[^#<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/, j = /\S/, k = /^\s+/, l = /\s+$/, m = /^<(\w+)\s*\/?>(?:<\/\1>)?$/, n = /^[\],:{}\s]*$/, o = /\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g, p = /"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g, q = /(?:^|:|,)(?:\s*\[)+/g, r = /(webkit)[ \/]([\w.]+)/, s = /(opera)(?:.*version)?[ \/]([\w.]+)/, t = /(msie) ([\w.]+)/, u = /(mozilla)(?:.*? rv:([\w.]+))?/, v = /-([a-z]|[0-9])/gi, w = /^-ms-/, x = function(a, b) {
            return (b + "").toUpperCase();
        }, y = d.userAgent, C = Object.prototype.toString, D = Object.prototype.hasOwnProperty, E = Array.prototype.push, F = Array.prototype.slice, G = String.prototype.trim, H = Array.prototype.indexOf, I = {};
        e.fn = e.prototype = {
            constructor: e,
            init: function(a, d, f) {
                var g, h, j, k;
                ...
                if ("string" == typeof a) {
                    g = "<" !== a.charAt(0) || ">" !== a.charAt(a.length - 1) || 3 > a.length ? i.exec(a) : [ null, a, null ];
                    if (g && (g[1] || !d)) {
                        if (g[1]) {
            ...
            "boolean" == typeof i && (l = i, i = arguments[1] || {}, j = 2), "object" != typeof i && !e.isFunction(i) && (i = {}), 
            k === j && (i = this, --j);
            for (;k > j; j++) if (null != (a = arguments[j])) for (c in a) {
                d = i[c], f = a[c];
                if (i === f) continue;
            ...
            bindReady: function() {
                if (!A) {
                    ...
                    if ("complete" === c.readyState) return setTimeout(e.ready, 1);
            ...
            each: function(a, c, d) {
                ...
                if (d) {
                    ...
                    } else for (;h > g; ) if (c.apply(a[g++], d) === !1) break;
                } else if (i) {
                    for (f in a) if (c.call(a[f], f, a[f]) === !1) break;
                } else for (;h > g; ) if (c.call(a[g], g, a[g++]) === !1) break;
                return a;
            },
            trim: G ? function(a) {
            ...
            merge: function(a, c) {
                var d = a.length, e = 0;
                if ("number" == typeof c.length) for (var f = c.length; f > e; e++) a[d++] = c[e]; else while (c[e] !== b) a[d++] = c[e++];
                a.length = d;
                return a;
            },
            grep: function(a, b, c) {
            ...
            map: function(a, c, d) {
                ...
                if (k) for (;j > i; i++) f = c(a[i], i, d), null != f && (h[h.length] = f); else for (g in a) f = c(a[g], g, d), 
                null != f && (h[h.length] = f);
    ...
    f.Callbacks = function(a) {
        a = a ? g[a] || h(a) : {};
        var e, i, j, k, l, c = [], d = [], m = function(b) {
            var d, e, g, h;
            for (d = 0, e = b.length; e > d; d++) g = b[d], h = f.type(g), "array" === h ? m(g) : "function" === h && (!a.unique || !o.has(g)) && c.push(g);
        }, n = function(b, f) {
            f = f || [], e = !a.memory || [ b, f ], i = !0, l = j || 0, j = 0, k = c.length;
            for (;c && k > l; l++) if (c[l].apply(b, f) === !1 && a.stopOnFalse) {
                e = !0;
                break;
            }
            ...
            remove: function() {
                if (c) {
                    ...
                    for (;e > d; d++) for (var f = 0; c.length > f; f++) if (b[d] === c[f]) {
                        i && k >= f && (k--, l >= f && l--), c.splice(f--, 1);
                        if (a.unique) break;
                    }
                }
                return this;
    ...
    f.extend({
        Deferred: function(a) {
            var j, b = f.Callbacks("once memory"), c = f.Callbacks("once memory"), d = f.Callbacks("memory"), e = "pending", g = {
                resolve: b,
                reject: c,
                notify: d
            }, h = {
        ...
        when: function(a) {
            ...
            var b = i.call(arguments, 0), c = 0, d = b.length, e = Array(d), g = d, j = 1 >= d && a && f.isFunction(a.promise) ? a : f.Deferred(), k = j.promise();
            if (d > 1) {
        ...
        i.setAttribute("type", "radio"), b.radioValue = "t" === i.value, i.setAttribute("checked", "checked"), 
        ...
        q.style.width = "2px", q.appendChild(j), b.reliableMarginRight = 0 === (parseInt((a.getComputedStyle(j, null) || {
            marginRight: 0
        }).marginRight, 10) || 0));
        if (q.attachEvent) for (o in {
            ...
            change: 1,
            focusin: 1
        }) n = "on" + o, p = n in q, p || (q.setAttribute(n, "return;"), p = "function" == typeof q[n]), 
        b[o + "Bubbles"] = p;
        k.removeChild(q), k = g = h = j = q = i = null, f(function() {
            var a, d, e, h, i, j, k, m, n, o, r = c.getElementsByTagName("body")[0];
            ...
            l = q.getElementsByTagName("td"), p = 0 === l[0].offsetHeight, l[0].style.display = "", 
            l[1].style.display = "none", b.reliableHiddenOffsets = p && 0 === l[0].offsetHeight, 
            q.innerHTML = "", q.style.width = q.style.paddingLeft = "1px", f.boxModel = b.boxModel = 2 === q.offsetWidth, 
            "undefined" != typeof q.style.zoom && (q.style.display = "inline", q.style.zoom = 1, 
            b.inlineBlockNeedsLayout = 2 === q.offsetWidth, q.style.display = "", q.innerHTML = "<div style='width:4px;'></div>", 
            b.shrinkWrapBlocks = 2 !== q.offsetWidth), q.style.cssText = k + m, q.innerHTML = o, 
            ...
            }, e.style.position = "fixed", e.style.top = "20px", i.fixedPosition = 20 === e.offsetTop || 15 === e.offsetTop, 
            e.style.position = e.style.top = "", d.style.overflow = "hidden", d.style.position = "relative", 
            i.subtractsBorderForOverflowNotVisible = -5 === e.offsetTop, i.doesNotIncludeMarginInBodyOffset = r.offsetTop !== j, 
    ...
    f.extend({
        ...
        data: function(a, c, d, e) {
            if (!!f.acceptData(a)) {
                var g, h, i, j = f.expando, k = "string" == typeof c, l = a.nodeType, m = l ? f.cache : a, n = l ? a[j] : a[j] && j, o = "events" === c;
                if (!(n && m[n] && (o || e || m[n].data) || !k || d !== b)) return;
                n || (l ? a[j] = n = ++f.uuid : n = j), m[n] || (m[n] = {}, l || (m[n].toJSON = f.noop));
                ("object" == typeof c || "function" == typeof c) && (e ? m[n] = f.extend(m[n], c) : m[n].data = f.extend(m[n].data, c));
                g = h = m[n], e || (h.data || (h.data = {}), h = h.data), d !== b && (h[f.camelCase(c)] = d);
                if (o && !h[c]) return g.events;
                k ? (i = h[c], null == i && (i = h[f.camelCase(c)])) : i = h;
                return i;
            }
        },
        ...
        data: function(a, c) {
            ...
            if ("undefined" == typeof a) {
                if (this.length) {
                    h = f.data(this[0]);
                    if (1 === this[0].nodeType && !f._data(this[0], "parsedAttrs")) {
                        e = this[0].attributes;
                        for (var i = 0, j = e.length; j > i; i++) g = e[i].name, 0 === g.indexOf("data-") && (g = f.camelCase(g.substring(5)), 
                        l(this[0], g, h[g]));
        ...
        promise: function(a, c) {
            ...
            var l, d = f.Deferred(), e = this, g = e.length, h = 1, i = a + "defer", j = a + "queue", k = a + "mark";
            while (g--) (l = f.data(e[g], i, b, !0) || (f.data(e[g], j, b, !0) || f.data(e[g], k, b, !0)) && f.data(e[g], i, f.Callbacks("once memory"), !0)) && (h++, 
            l.add(m));
            m();
            return d.promise();
        }
    });
    var w, x, y, o = /[\n\t\r]/g, p = /\s+/, q = /\r/g, r = /^(?:button|input)$/i, s = /^(?:button|input|object|select|textarea)$/i, t = /^a(?:rea)?$/i, u = /^(?:autofocus|autoplay|async|checked|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped|selected)$/i, v = f.support.getSetAttribute;
    f.fn.extend({
        attr: function(a, b) {
            ...
            if (a && "string" == typeof a) {
                ...
                for (c = 0, d = this.length; d > c; c++) {
                    ...
                    if (1 === e.nodeType) if (e.className || 1 !== b.length) {
                        g = " " + e.className + " ";
                        for (h = 0, i = b.length; i > h; h++) ~g.indexOf(" " + b[h] + " ") || (g += b[h] + " ");
        ...
        removeClass: function(a) {
            ...
            if (a && "string" == typeof a || a === b) {
                ...
                for (d = 0, e = this.length; e > d; d++) {
                    g = this[d];
                    if (1 === g.nodeType && g.className) if (a) {
                        h = (" " + g.className + " ").replace(o, " ");
                        for (i = 0, j = c.length; j > i; i++) h = h.replace(" " + c[i] + " ", " ");
        ...
        toggleClass: function(a, b) {
            ...
            return this.each(function() {
                ...
                } else ("undefined" === c || "boolean" === c) && (this.className && f._data(this, "__className__", this.className), 
                this.className = this.className || a === !1 ? "" : f._data(this, "__className__") || "");
            });
        },
        hasClass: function(a) {
            var b = " " + a + " ", c = 0, d = this.length;
            for (;d > c; c++) if (1 === this[c].nodeType && (" " + this[c].className + " ").replace(o, " ").indexOf(b) > -1) return !0;
            return !1;
        },
        val: function(a) {
            var c, d, e, g = this[0];
            if (!!arguments.length) {
                ...
                return this.each(function(d) {
                    var h, g = f(this);
                    if (1 === this.nodeType) {
                        h = e ? a.call(this, d, g.val()) : a, null == h ? h = "" : "number" == typeof h ? h += "" : f.isArray(h) && (h = f.map(h, function(a) {
                            return null == a ? "" : a + "";
            ...
            if (g) {
                ...
                d = g.value;
                return "string" == typeof d ? d.replace(q, "") : null == d ? "" : d;
            }
        }
    }), f.extend({
        valHooks: {
            ...
            select: {
                get: function(a) {
                    var b, c, d, e, g = a.selectedIndex, h = [], i = a.options, j = "select-one" === a.type;
                    if (0 > g) return null;
                    c = j ? g : 0, d = j ? g + 1 : i.length;
                    for (;d > c; c++) {
                        e = i[c];
                        if (!(!e.selected || (f.support.optDisabled ? e.disabled : null !== e.getAttribute("disabled")) || e.parentNode.disabled && f.nodeName(e.parentNode, "optgroup"))) {
                            b = f(e).val();
                            if (j) return b;
                            h.push(b);
                        }
        ...
        attr: function(a, c, d, e) {
            ...
            if (!!a && 3 !== j && 8 !== j && 2 !== j) {
                ...
                if ("undefined" == typeof a.getAttribute) return f.prop(a, c, d);
                i = 1 !== j || !f.isXMLDoc(a), i && (c = c.toLowerCase(), h = f.attrHooks[c] || (u.test(c) ? x : w));
                if (d !== b) {
                    if (null === d) {
                        f.removeAttr(a, c);
                        return;
                ...
                if (h && "get" in h && i && null !== (g = h.get(a, c))) return g;
                g = a.getAttribute(c);
                return null === g ? b : g;
            }
        },
        removeAttr: function(a, b) {
            ...
            if (b && 1 === a.nodeType) {
                ...
                for (;g > h; h++) e = d[h], e && (c = f.propFix[e] || e, f.attr(a, e, ""), a.removeAttribute(v ? e : c), 
        ...
        attrHooks: {
            type: {
                set: function(a, b) {
                    if (r.test(a.nodeName) && a.parentNode) f.error("type property can't be changed"); else if (!f.support.radioValue && "radio" === b && f.nodeName(a, "input")) {
                        var c = a.value;
        ...
        prop: function(a, c, d) {
            ...
            if (!!a && 3 !== i && 8 !== i && 2 !== i) {
                h = 1 !== i || !f.isXMLDoc(a), h && (c = f.propFix[c] || c, g = f.propHooks[c]);
                return d !== b ? g && "set" in g && (e = g.set(a, d, c)) !== b ? e : a[c] = d : g && "get" in g && null !== (e = g.get(a, c)) ? e : a[c];
            }
        },
        propHooks: {
            tabIndex: {
    ...
    f.event = {
            ...
            if (!(3 === a.nodeType || 8 === a.nodeType || !c || !d || !(h = f._data(a)))) {
                ...
                for (k = 0; c.length > k; k++) {
                    ...
                    if (!r) {
                        ...
                        s.setup && s.setup.call(a, e, n, i) !== !1 || (a.addEventListener ? a.addEventListener(m, i, !1) : a.attachEvent && a.attachEvent("on" + m, i));
                    }
        ...
        remove: function(a, b, c, d, e) {
            ...
            if (!!g && !!(o = g.events)) {
                ...
                for (h = 0; b.length > h; h++) {
                    ...
                    for (n = 0; r.length > n; n++) s = r[n], !(!e && k !== s.origType || c && c.guid !== s.guid || l && !l.test(s.namespace) || d && d !== s.selector && ("**" !== d || !s.selector) || (r.splice(n--, 1), 
                    s.selector && r.delegateCount--, !p.remove || !p.remove.call(a, s)));
                    0 === r.length && m !== r.length && ((!p.teardown || p.teardown.call(a, l) === !1) && f.removeEvent(a, j, g.handle), 
                    delete o[j]);
                }
        ...
        trigger: function(c, d, e, g) {
            if (!e || 3 !== e.nodeType && 8 !== e.nodeType) {
                var j, k, l, m, n, o, p, q, r, s, h = c.type || c, i = [];
                if (E.test(h + f.event.triggered)) return;
                h.indexOf("!") >= 0 && (h = h.slice(0, -1), k = !0), h.indexOf(".") >= 0 && (i = h.split("."), 
                h = i.shift(), i.sort());
                if ((!e || f.event.customEvent[h]) && !f.event.global[h]) return;
                c = "object" == typeof c ? c[f.expando] ? c : new f.Event(h, c) : new f.Event(h), 
                ...
                c.result = b, c.target || (c.target = e), d = null != d ? f.makeArray(d) : [], d.unshift(c), 
                p = f.event.special[h] || {};
                ...
                for (l = 0; r.length > l && !c.isPropagationStopped(); l++) m = r[l][0], c.type = r[l][1], 
                q = (f._data(m, "events") || {})[c.type] && f._data(m, "handle"), q && q.apply(m, d), 
                q = o && m[o], q && f.acceptData(m) && q.apply(m, d) === !1 && c.preventDefault();
                c.type = h, !(g || c.isDefaultPrevented() || p._default && p._default.apply(e.ownerDocument, d) !== !1 || "click" === h && f.nodeName(e, "a") || !f.acceptData(e) || !o || !e[h] || ("focus" === h || "blur" === h) && 0 === c.target.offsetWidth || f.isWindow(e) || (n = e[o], 
        ...
        dispatch: function(c) {
            ...
            var j, k, l, m, n, o, p, q, r, s, d = (f._data(this, "events") || {})[c.type] || [], e = d.delegateCount, g = [].slice.call(arguments, 0), h = !c.exclusive && !c.namespace, i = [];
            g[0] = c, c.delegateTarget = this;
            if (e && !c.target.disabled && (!c.button || "click" !== c.type)) {
                m = f(this), m.context = this.ownerDocument || this;
                for (l = c.target; l != this; l = l.parentNode || this) {
                    o = {}, q = [], m[0] = l;
                    for (j = 0; e > j; j++) r = d[j], s = r.selector, o[s] === b && (o[s] = r.quick ? H(l, r.quick) : m.is(s)), 
                    o[s] && q.push(r);
                    q.length && i.push({
                        elem: l,
                        matches: q
            ...
            for (j = 0; i.length > j && !c.isPropagationStopped(); j++) {
                p = i[j], c.currentTarget = p.elem;
                for (k = 0; p.matches.length > k && !c.isImmediatePropagationStopped(); k++) {
                    r = p.matches[k];
                    (h || !c.namespace && !r.namespace || c.namespace_re && c.namespace_re.test(r.namespace)) && (c.data = r.data, 
        ...
        mouseHooks: {
            ...
            filter: function(a, d) {
                ...
                null == a.pageX && null != d.clientX && (e = a.target.ownerDocument || c, f = e.documentElement, 
                g = e.body, a.pageX = d.clientX + (f && f.scrollLeft || g && g.scrollLeft || 0) - (f && f.clientLeft || g && g.clientLeft || 0), 
                a.pageY = d.clientY + (f && f.scrollTop || g && g.scrollTop || 0) - (f && f.clientTop || g && g.clientTop || 0)), 
                !a.relatedTarget && i && (a.relatedTarget = i === a.target ? d.toElement : i), !a.which && h !== b && (a.which = 1 & h ? 1 : 2 & h ? 3 : 4 & h ? 2 : 0);
                return a;
            }
        },
        fix: function(a) {
            ...
            a.target || (a.target = g.srcElement || c), 3 === a.target.nodeType && (a.target = a.target.parentNode), 
        ...
        f.event.special[a] = {
            ...
            bindType: b,
            handle: function(a) {
                var h, c = this, d = a.relatedTarget, e = a.handleObj;
                e.selector;
                (!d || d !== c && !f.contains(c, d)) && (a.type = e.origType, h = e.handler.apply(this, arguments), 
                a.type = b);
                return h;
            }
        };
        ...
        setup: function() {
            if (z.test(this.nodeName)) {
                ("checkbox" === this.type || "radio" === this.type) && (f.event.add(this, "propertychange._change", function(a) {
        ...
        var m = function(b, d, e, f) {
            ...
            if (w.length > 1 && p.exec(b)) if (2 === w.length && o.relative[w[0]]) j = y(w[0] + w[1], d, f); else {
                j = o.relative[w[0]] ? [ d ] : m(w.shift(), d);
                while (w.length) b = w.shift(), o.relative[b] && (b += w.shift()), j = y(b, j, f);
            } else {
                !f && w.length > 1 && 9 === d.nodeType && !v && o.match.ID.test(w[0]) && !o.match.ID.test(w[w.length - 1]) && (n = m.find(w.shift(), d, v), 
                d = n.expr ? m.filter(n.expr, n.set)[0] : n.set[0]);
                if (d) {
                    n = f ? {
                        expr: w.pop(),
                        set: s(f)
                    } : m.find(w.pop(), 1 !== w.length || "~" !== w[0] && "+" !== w[0] || !d.parentNode ? d : d.parentNode, v), 
                    j = n.expr ? m.filter(n.expr, n.set) : n.set, w.length > 0 ? k = s(j) : u = !1;
                    while (w.length) q = w.pop(), r = q, o.relative[q] ? r = w.pop() : q = "", null == r && (r = d), 
                    o.relative[q](k, r, v);
                } else k = w = [];
            }
            k || (k = j), k || m.error(q || b);
            if ("[object Array]" === g.call(k)) if (u) if (d && 1 === d.nodeType) for (t = 0; null != k[t]; t++) k[t] && (k[t] === !0 || 1 === k[t].nodeType && m.contains(d, k[t])) && e.push(j[t]); else for (t = 0; null != k[t]; t++) k[t] && 1 === k[t].nodeType && e.push(j[t]); else e.push.apply(e, k); else s(k, e);
        ...
        m.uniqueSort = function(a) {
            if (u) {
                h = i, a.sort(u);
                if (h) for (var b = 1; a.length > b; b++) a[b] === a[b - 1] && a.splice(b--, 1);
            }
            return a;
        ...
        var n = m.getText = function(a) {
            ...
            relative: {
                "+": function(a, b) {
                    ...
                    for (var h, f = 0, g = a.length; g > f; f++) if (h = a[f]) {
                        while ((h = h.previousSibling) && 1 !== h.nodeType) ;
            ...
            find: {
                ...
                NAME: function(a, b) {
                    if ("undefined" != typeof b.getElementsByName) {
                        ...
                        for (var e = 0, f = d.length; f > e; e++) d[e].getAttribute("name") === a[1] && c.push(d[e]);
            ...
            filter: {
                PSEUDO: function(a, b, c, d) {
                    ...
                    if ("not" === e) {
                        var g = b[3];
                        for (var h = 0, i = g.length; i > h; h++) if (g[h] === a) return !1;
                        return !0;
                    }
                    m.error(e);
                },
                CHILD: function(a, b) {
                    var c, e, f, g, i, j, k = b[1], l = a;
                    switch (k) {
                      case "only":
                      case "first":
                        while (l = l.previousSibling) if (1 === l.nodeType) return !1;
                        if ("first" === k) return !0;
                        l = a;

                      case "last":
                        while (l = l.nextSibling) if (1 === l.nodeType) return !1;
                        return !0;
                      ...
                      case "nth":
                        ...
                        if (g && (g[d] !== f || !a.nodeIndex)) {
                            i = 0;
                            for (l = g.firstChild; l; l = l.nextSibling) 1 === l.nodeType && (l.nodeIndex = ++i);
                            g[d] = f;
                        }
                        j = a.nodeIndex - e;
                        return 0 === c ? 0 === j : 0 === j % c && j / c >= 0;
                    }
                },
                ID: function(a, b) {
        ...
        c.documentElement.compareDocumentPosition ? u = function(a, b) {
            ...
            a.appendChild(c.createComment("")), a.getElementsByTagName("*").length > 0 && (o.find.TAG = function(a, b) {
                ...
                if ("*" === a[1]) {
                    var d = [];
                    for (var e = 0; c[e]; e++) 1 === c[e].nodeType && d.push(c[e]);
                    c = d;
                }
                return c;
            ...
            if (!!a.getElementsByClassName && 0 !== a.getElementsByClassName("e").length) {
                a.lastChild.className = "e";
                if (1 === a.getElementsByClassName("e").length) return;
    ...
    f.fn.extend({
        find: function(a) {
            ...
            for (c = 0, d = this.length; d > c; c++) {
                ...
                if (c > 0) for (h = g; e.length > h; h++) for (i = 0; g > i; i++) if (e[i] === e[h]) {
                    e.splice(h--, 1);
                    break;
                }
            }
        ...
        index: function(a) {
            ...
            if ("string" == typeof a) return f.inArray(this[0], f(a));
        ...
        f.fn[a] = function(c, d) {
            ...
            L.test(a) || (d = c), d && "string" == typeof d && (e = f.filter(d, e)), e = this.length > 1 && !R[a] ? f.unique(e) : e, 
        ...
        dir: function(a, c, d) {
            var e = [], g = a[c];
            while (g && 9 !== g.nodeType && (d === b || 1 !== g.nodeType || !f(g).is(d))) 1 === g.nodeType && e.push(g), 
            g = g[c];
            return e;
        },
        nth: function(a, b, c) {
            b = b || 1;
            var e = 0;
            for (;a; a = a[c]) if (1 === a.nodeType && ++e === b) break;
            return a;
        },
    ...
    f.fn.extend({
        text: function(a) {
            ...
            if ("object" != typeof a && a !== b) return this.empty().append((this[0] && this[0].ownerDocument || c).createTextNode(a));
            return f.text(this);
        },
        wrapAll: function(a) {
            if (f.isFunction(a)) return this.each(function(b) {
        ...
        remove: function(a, b) {
            for (var d, c = 0; null != (d = this[c]); c++) (!a || f.filter(a, [ d ]).length) && (!b && 1 === d.nodeType && (f.cleanData(d.getElementsByTagName("*")), 
        ...
        html: function(a) {
            ...
            if ("string" != typeof a || ba.test(a) || !f.support.leadingWhitespace && X.test(a) || bg[(Z.exec(a) || [ "", "" ])[1].toLowerCase()]) f.isFunction(a) ? this.each(function(b) {
                ...
                a = a.replace(Y, "<$1></$2>");
                try {
                    for (var c = 0, d = this.length; d > c; c++) 1 === this[c].nodeType && (f.cleanData(this[c].getElementsByTagName("*")), 
                    this[c].innerHTML = a);
                } catch (e) {
                    this.empty().append(a);
                }
        ...
        domManip: function(a, c, d) {
            ...
            if (this[0]) {
                i = j && j.parentNode, e = f.support.parentNode && i && 11 === i.nodeType && i.childNodes.length === this.length ? {
                    fragment: i
        ...
        1 === a.length && "string" == typeof j && 512 > j.length && i === c && "<" === j.charAt(0) && !bb.test(j) && (f.support.checkClone || !bd.test(j)) && (f.support.html5Clone || !bc.test(j)) && (g = !0, 
        h = f.fragments[j], h && 1 !== h && (e = h)), e || (e = i.createDocumentFragment(), 
        ...
        clean: function(a, b, d, e) {
            ...
            for (var k, j = 0; null != (k = a[j]); j++) {
                ...
                var r;
                if (!f.support.appendChecked) if (k[0] && "number" == typeof (r = k.length)) for (i = 0; r > i; i++) bn(k[i]); else bn(k);
            ...
            if (d) {
                ...
                for (j = 0; h[j]; j++) if (!e || !f.nodeName(h[j], "script") || h[j].type && "text/javascript" !== h[j].type.toLowerCase()) {
                    if (1 === h[j].nodeType) {
    ...
    var bz, bA, bB, bq = /alpha\([^)]*\)/i, br = /opacity=([^)]*)/, bs = /([A-Z]|^ms)/g, bt = /^-?\d+(?:px)?$/i, bu = /^-?\d/, bv = /^([\-+])=([\-+.\de]+)/, bw = {
        position: "absolute",
        visibility: "hidden",
        display: "block"
    }, bx = [ "Left", "Right" ], by = [ "Top", "Bottom" ];
    f.fn.css = function(a, c) {
        if (2 === arguments.length && c === b) return this;
        ...
        style: function(a, c, d, e) {
            if (!!a && 3 !== a.nodeType && 8 !== a.nodeType && !!a.style) {
                ...
                h = typeof d, "string" === h && (g = bv.exec(d)) && (d = +(g[1] + 1) * +g[2] + parseFloat(f.css(a, c)), 
                h = "number");
                if (null == d || "number" === h && isNaN(d)) return;
        ...
        css: function(a, c, d) {
            var e, g;
            c = f.camelCase(c), g = f.cssHooks[c], c = f.cssProps[c] || c, "cssFloat" === c && (c = "float");
        ...
        f.cssHooks[b] = {
            get: function(a, c, d) {
                var e;
                if (c) {
                    if (0 !== a.offsetWidth) return bC(a, b, d);
        ...
        set: function(a, b) {
            var c = a.style, d = a.currentStyle, e = f.isNumeric(b) ? "alpha(opacity=" + 100 * b + ")" : "", g = d && d.filter || c.filter || "";
            c.zoom = 1;
        ...
        null === f && g && (e = g[b]) && (f = e), !bt.test(f) && bu.test(f) && (c = g.left, 
    ...
    var bV, bW, bD = /%20/g, bE = /\[\]$/, bF = /\r?\n/g, bG = /#.*$/, bH = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm, bI = /^(?:color|date|datetime|datetime-local|email|hidden|month|number|password|range|search|tel|text|time|url|week)$/i, bJ = /^(?:about|app|app\-storage|.+\-extension|file|res|widget):$/, bK = /^(?:GET|HEAD)$/, bL = /^\/\//, bM = /\?/, bN = /<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi, bO = /^(?:select|textarea)/i, bP = /\s+/, bQ = /([?&])_=[^&]*/, bR = /^([\w\+\.\-]+:)(?:\/\/([^\/?#:]*)(?::(\d+))?)?/, bS = f.fn.load, bT = {}, bU = {}, bX = [ "*/" ] + [ "*" ];
    try {
        bV = e.href;
    } catch (bY) {
    ...
    bW = bR.exec(bV.toLowerCase()) || [], f.fn.extend({
        load: function(a, c, d) {
            ...
            var h = "GET";
            c && (f.isFunction(c) ? (d = c, c = b) : "object" == typeof c && (c = f.param(c, f.ajaxSettings.traditional), 
            h = "POST"));
            var i = this;
            f.ajax({
                url: a,
        ...
        ajax: function(a, c) {
            function w(a, c, l, m) {
                if (2 !== s) {
                    ...
                    var o, r, u, y, z, w = c, x = l ? cb(d, v, l) : b;
                    if (a >= 200 && 300 > a || 304 === a) {
                        if (d.ifModified) {
                            (y = v.getResponseHeader("Last-Modified")) && (f.lastModified[k] = y);
                            (z = v.getResponseHeader("Etag")) && (f.etag[k] = z);
                        }
                        if (304 === a) w = "notmodified", o = !0; else try {
            ...
            var k, n, o, p, q, r, t, u, d = f.ajaxSetup({}, c), e = d.context || d, g = e !== d && (e.nodeType || e instanceof f) ? f(e) : f.event, h = f.Deferred(), i = f.Callbacks("once memory"), j = d.statusCode || {}, l = {}, m = {}, s = 0, v = {
                readyState: 0,
            ...
            null == d.crossDomain && (r = bR.exec(d.url.toLowerCase()), d.crossDomain = !(!r || r[1] == bW[1] && r[2] == bW[2] && (r[3] || ("http:" === r[1] ? 80 : 443)) == (bW[3] || ("http:" === bW[1] ? 80 : 443)))), 
            d.data && d.processData && "string" != typeof d.data && (d.data = f.param(d.data, d.traditional)), 
            b$(bT, d, c, v);
            if (2 === s) return !1;
            t = d.global, d.type = d.type.toUpperCase(), d.hasContent = !bK.test(d.type), t && 0 === f.active++ && f.event.trigger("ajaxStart");
            if (!d.hasContent) {
    ...
    f.ajaxSetup({
        ...
        if ("jsonp" === b.dataTypes[0] || b.jsonp !== !1 && (ce.test(b.url) || e && ce.test(b.data))) {
                    ...
                    h.send(c.hasContent && c.data || null), d = function(a, e) {
                        ...
                        try {
                            if (d && (e || 4 === h.readyState)) {
                                ...
                                if (e) 4 !== h.readyState && h.abort(); else {
                        ...
                        m && g(j, k, m, l);
                    }, c.async && 4 !== h.readyState ? (i = ++cg, cf && (ch || (ch = {}, f(a).unload(cf)), 
                    ch[i] = d), h.onreadystatechange = d) : d();
                },
                abort: function() {
                    d && d(0, 1);
                }
    ...
    var cl, cm, cp, cr, ck = {}, cn = /^(?:toggle|show|hide)$/, co = /^([+\-]=)?([\d+.\-]+)([a-z%]*)$/i, cq = [ [ "height", "marginTop", "marginBottom", "paddingTop", "paddingBottom" ], [ "width", "marginLeft", "marginRight", "paddingLeft", "paddingRight" ], [ "opacity" ] ];
    f.fn.extend({
        show: function(a, b, c) {
            var d, e;
            if (a || 0 === a) return this.animate(cu("show", 3), a, b, c);
            for (var g = 0, h = this.length; h > g; g++) d = this[g], d.style && (e = d.style.display, 
            !f._data(d, "olddisplay") && "none" === e && (e = d.style.display = ""), "" === e && "none" === f.css(d, "display") && f._data(d, "olddisplay", cv(d.nodeName)));
            for (g = 0; h > g; g++) {
                d = this[g];
                if (d.style) {
                    e = d.style.display;
        ...
        hide: function(a, b, c) {
            ...
            for (;h > g; g++) d = this[g], d.style && (e = f.css(d, "display"), "none" !== e && !f._data(d, "olddisplay") && f._data(d, "olddisplay", e));
        ...
        animate: function(a, b, c, d) {
            function g() {
                ...
                for (i in a) {
                    ...
                    "inline" === f.css(this, "display") && "none" === f.css(this, "float") && (f.support.inlineBlockNeedsLayout && "inline" !== cv(this.nodeName) ? this.style.zoom = 1 : this.style.display = "inline-block"));
                }
                null != b.overflow && (this.style.overflow = "hidden");
                for (i in a) j = new f.fx(this, b, i), h = a[i], cn.test(h) ? (o = f._data(this, "toggle" + i) || ("toggle" === h ? d ? "show" : "hide" : 0), 
                o ? (f._data(this, "toggle" + i, "show" === o ? "hide" : "show"), j[o]()) : j[h]()) : (k = co.exec(h), 
                l = j.cur(), k ? (m = parseFloat(k[2]), n = k[3] || (f.cssNumber[i] ? "" : "px"), 
                "px" !== n && (f.style(this, i, (m || 1) + n), l = (m || 1) / j.cur() * l, f.style(this, i, l + n)), 
        ...
        stop: function(a, c, d) {
            "string" != typeof a && (d = c, c = a, a = b), c && a !== !1 && this.queue(a || "fx", []);
            return this.each(function() {
                function h(a, b, c) {
                    var e = b[c];
                ...
                d || f._unmark(!0, this);
                if (null == a) for (b in g) g[b] && g[b].stop && b.indexOf(".run") === b.length - 4 && h(this, g, b); else g[b = a + ".run"] && g[b].stop && h(this, g, b);
                for (b = e.length; b--; ) e[b].elem === this && (null == a || e[b].queue === a) && (d ? e[b](!0) : e[b].saveState(), 
                c = !0, e.splice(b, 1));
        ...
        step: function(a) {
            ...
            if (a || e >= i.duration + this.startTime) {
                ...
                if (g) {
                    null != i.overflow && !f.support.shrinkWrapBlocks && f.each([ "", "X", "Y" ], function(a, b) {
            ...
            1/0 == i.duration ? this.now = e : (c = e - this.startTime, this.state = c / i.duration, 
        ...
        tick: function() {
            ...
            for (;b.length > c; c++) a = b[c], !a() && b[c] === a && b.splice(c--, 1);
            b.length || f.fx.stop();
        },
        interval: 13,
        stop: function() {
    ...
    f.fn.offset = "getBoundingClientRect" in c.documentElement ? function(a) {
        ...
        while ((b = b.parentNode) && b !== i && b !== h) {
            if (f.support.fixedPosition && "fixed" === k.position) break;
            ...
            m += parseFloat(c.borderLeftWidth) || 0), e = d, d = b.offsetParent), f.support.subtractsBorderForOverflowNotVisible && "visible" !== c.overflow && (l += parseFloat(c.borderTopWidth) || 0, 
            m += parseFloat(c.borderLeftWidth) || 0), k = c;
        }
        ("relative" === k.position || "static" === k.position) && (l += i.offsetTop, m += i.offsetLeft);
        f.support.fixedPosition && "fixed" === k.position && (l += Math.max(h.scrollTop, i.scrollTop), 
        ...
        setOffset: function(a, b, c) {
            ...
            f.isFunction(b) && (b = b.call(a, c, g)), null != b.top && (k.top = b.top - g.top + m), 
            null != b.left && (k.left = b.left - g.left + n), "using" in b ? b.using.call(a, k) : e.css(k);
        }
    }, f.fn.extend({
        position: function() {
        ...
        offsetParent: function() {
            return this.map(function() {
                ...
                while (a && !cx.test(a.nodeName) && "static" === f.css(a, "position")) a = a.offsetParent;
                return a;
            });
        }
